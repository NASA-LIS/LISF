...
| "`LDTSI post`"                | special postprocessing mode for LDTSI
|===
...
| "`SMAP soil moistu`"              | SMAP soil moisture data
...
`LDTSI output GRIB2 native grid:` Specifies if LDTSI should be output in GRIB2 (no interpolation).  Acceptable values are:
...
`LDTSI output GRIB1 global 0.25deg lat/lon:` Specifies if LDTSI should be interpolated to 0.25 deg lat/lon grid and output in GRIB1.  Acceptable values are:
...
`LDTSI output GRIB1 NH 16th mesh polar stereographic:` Specifies if LDTSI should be interpolated to Northern Hemispheric 16th mesh polar stereographic grid and output in GRIB1.  Acceptable values are:
...
`LDTSI output GRIB 1 SH 16th mesh polar stereographic:` Specifies if LDTSI should be interpolated to Southern Hemispheric 16th mesh polar stereographic grid and output in GRIB1.  Acceptable values are:
...
`LDTSI input netcdf directory:` Specifies path of directory containing LDTSI netcdf files to process.
...
`LDTSI output grib directory:` Specifies path of directory to write GRIB2 and/or GRIB1 files.
