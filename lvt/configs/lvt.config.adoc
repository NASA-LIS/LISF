...
`USAFSI output GRIB 1 SH 16th mesh polar stereographic:` Specifies if USAFSI should be interpolated to Southern Hemispheric 16th mesh polar stereographic grid and output in GRIB1.  Acceptable values are:
