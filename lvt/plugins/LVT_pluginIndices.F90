...
!   The user may change these options, and the lvt.config
...
!  19 Nov 2018  Mahdi Navari added suport to read SMAP_L3 brightness
!               temperature
!  10 Jan 2023  Mahdi Navari added suport for COAMPSout
!  23 Jul 2025  Mahdi Navari/Eric Kemp, Added SMAP NRT L2 SM.
!
!EOP
module LVT_pluginIndices
  ...
  integer, public,  parameter :: LVT_DFRid         = 43
  integer, public,  parameter :: LVT_EFid          = 44
  integer, public,  parameter :: LVT_FFid          = 45
  integer, public,  parameter :: LVT_HSSid          = 46
  integer, public,  parameter :: LVT_PSSid          = 47
  integer, public,  parameter :: LVT_CSSid          = 48
  ...
  !These are always registered, so they must have unique values
  ...
  ! Run modes
  !-----------------------------------------------------------------------
  character*50, public,  parameter :: LVT_DataCompId = &
       "Data intercomparison"
  character*50, public,  parameter :: LVT_dastatId = &
       "DA statistics processing"
  character*50, public,  parameter :: LVT_benchMarkId = "Benchmarking"
  character*50, public,  parameter :: LVT_daobsId = &
       "DA observation processing"
  character*50, public,  parameter :: LVT_optUEId  = &
       "OPTUE output processing"
  character*50, public,  parameter :: LVT_rtmrunId  = &
  ...
  character*50, public,  parameter :: LVT_LISoutputId        &
       = "LIS output"
  character*50, public,  parameter :: LVT_LISdaobsId         = "LIS DAOBS"
  character*50, public,  parameter :: LVT_LIS6outputId       &
       = "LIS6 output"
  character*50, public,  parameter :: LVT_LISDAdiagoutputId  &
       = "LIS DA diagnostics"
  ...
  character*50, public,  parameter :: LVT_SCANGMAOobsId      &
       = "SCAN(GMAO)"
  ...
  character*50, public,  parameter :: LVT_NASAAMSREsmobsId   &
       = "AMSR-E NASA soil moisture"
  character*50, public,  parameter :: LVT_LPRMAMSREsmobsId   &
  ...
  character*50, public,  parameter :: LVT_SNODEPmetobsId     &
       = "SNODEP metobs"
  ...
  character*50, public,  parameter :: LVT_ANSASNWDobsId      &
       = "ANSA snow depth"
  character*50, public,  parameter :: LVT_ANSASWEobsId       = "ANSA SWE"
  character*50, public,  parameter :: LVT_CPCPRCPobsId       &
       = "CPC precipitation"
  character*50, public,  parameter :: LVT_USGSSFobsId        &
       = "USGS streamflow"
  character*50, public,  parameter :: LVT_USGSSFgridobsId    &
       = "USGS streamflow gridded"
  character*50, public,  parameter :: LVT_NatSFobsId         &
       = "Naturalized streamflow"
  character*50, public,  parameter :: LVT_FLUXNETmteObsId    &
       = "FLUXNET MTE"
  character*50, public,  parameter :: LVT_FLUXNET2015ObsId   &
       = "FLUXNET2015 dataset"
  character*50, public,  parameter :: LVT_FLUXNET2015NCObsId &
  ...
  character*50, public,  parameter :: LVT_ARSsmobsId         &
  ...
  character*50, public,  parameter :: LVT_simGRACEobsId      &
       = "simulated GRACE"
  character*50, public,  parameter :: LVT_USGSGWwellobsId    &
       = "USGS ground water well data"
  character*50, public,  parameter :: LVT_PBOH2OobsId        = "PBO H2O"
  character*50, public,  parameter :: LVT_SMOSL2smobsId      &
       = "SMOS L2 soil moisture"
  character*50, public,  parameter :: LVT_SMOSNESDISsmobsId  &
       = "SMOS (NESDIS) soil moisture"
  character*50, public,  parameter :: LVT_SMOSCATDSsmobsId   &
       = "SMOS (CATDS) soil moisture"
  character*50, public,  parameter :: LVT_SMOSL1TBobsId      &
       = "SMOS L1 TB"
  character*50, public,  parameter :: LVT_GCOMW_AMSR2L3smobsId  &
       = "GCOMW AMSR2 L3 soil moisture"
  character*50, public,  parameter :: LVT_GCOMW_AMSR2L3sndobsId  &
       = "GCOMW AMSR2 L3 snow depth"
  character*50, public,  parameter :: LVT_SMOPSsmobsId  &
       = "SMOPS soil moisture"
  character*50, public,  parameter :: LVT_ESACCIsmobsId &
       = "ESA CCI soil moisture"
  character*50, public,  parameter :: LVT_GIMMSAVHRR_NDVIobsId &
       = "GIMMS AVHRR NDVI"
  character*50, public,  parameter :: LVT_GIMMSMODIS_NDVIobsId &
       = "GIMMS MODIS NDVI"
  ...
  character*50, public,  parameter :: LVT_ERAIlandobsId  &
       = "ERA interim land"
  ...
  character*50, public,  parameter :: LVT_GLERLobsId     &
       = "GLERL hydro data"
  character*50, public,  parameter :: LVT_JULESobsId     = "JULES data"
  character*50, public,  parameter :: LVT_JULES2dobsId   = "JULES 2d data"
  character*50, public,  parameter :: LVT_SMAPsmobsId    &
       = "SMAP soil moisture"
  character*50, public,  parameter :: LVT_SMAPNRTsmobsId &
       = "SMAP L2 NRT soil moisture"
  character*50, public,  parameter :: LVT_SMAPvodobsId   &
       = "SMAP vegetation optical depth"
  character*50, public,  parameter :: LVT_LPRMvodobsId   &
       = "LPRM vegetation optical depth"
  character*50, public,  parameter :: LVT_SMAPvwcobsId   &
       = "SMAP vegetation water content"
  character*50, public,  parameter :: LVT_SMAP_L3TbId    &
       = "SMAP L3 Tb"
  ...
  character*50, public,  parameter :: LVT_LVTbenchmarkobsId &
       = "LVT benchmark"
  ...
  character*50, public,  parameter :: LVT_USCRNsmdataId  &
       = "USCRN soil moisture"
  character*50, public,  parameter :: LVT_GLEAMdataId    = "GLEAM"
  character*50, public,  parameter :: LVT_USDMdataId     = "USDM"
  character*50, public,  parameter :: LVT_IMDprcpdataId  &
       = "IMD gridded precipitation"
  character*50, public,  parameter :: LVT_APHROprcpdataId &
       = "APHRODITE precipitation"
  character*50, public,  parameter :: LVT_LVTpercentiledataId &
       = "LVT percentile"
  character*50, public,  parameter :: LVT_GLASSlaiobsId = "GLASS LAI"
  character*50, public,  parameter :: LVT_GLASSalbedoobsId &
       = "GLASS ALBEDO"
  character*50, public,  parameter :: LVT_MODISsportLAIobsId &
       = "MODIS SPORT LAI"
  ...
  character*50, public,  parameter :: LVT_JASMINsmobsId &
  ...
  character*50, public,  parameter :: LVT_SMAP_E_OPLId &
       = "OPL E SMAP soil moisture retrieval"
  !-----------------------------------------------------------------------
  ! Training algorithms
  !-----------------------------------------------------------------------
  character*50, public,  parameter :: LVT_LinearRegressionId &
       = "Linear regression"
