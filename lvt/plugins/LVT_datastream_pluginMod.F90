...
!  19 Nov 2018  Mahdi Navari added support to read SMAP_L3 brightness
!               temperature
!  10 Jan 2023  Mahdi Navari added support for COAMPSout
!  23 Jul 2023  Mahdi Navari/Eric Kemp:  Add SMAP NRT L2 support.
!
!EOP
module LVT_datastream_pluginMod
...
contains
  ...
  subroutine LVT_datastream_plugin
    ...
    external :: registerobsread
    external :: registerobssetup
    ...
    external readSMAPvwcobs
    external readSMAP_L3TB
    ...
    call registerobssetup(trim(LVT_templateobsId)//char(0), &
         template_obsInit)
    call registerobsread(trim(LVT_templateobsId)//char(0), &
         readtemplateObs)
    ...
    call registerobssetup(trim(LVT_SCANGMAOobsId)//char(0), &
         SCANGMAO_obsinit)
    call registerobsread(trim(LVT_SCANGMAOobsId)//char(0), &
         readSCANGMAOObs)
    ...
    call registerobssetup(trim(LVT_SURFRADobsId)//char(0), &
         SURFRAD_obsinit)
    call registerobsread(trim(LVT_SURFRADobsId)//char(0), &
         readSURFRADObs)
    ...
    call registerobssetup(trim(LVT_CMCSNWDobsId)//char(0), &
         CMCSNWD_obsinit)
    ...
    call registerobssetup(trim(LVT_AmerifluxobsId)//char(0), &
         Ameriflux_obsinit)
    call registerobsread(trim(LVT_AmerifluxobsId)//char(0), &
         readAmerifluxObs)

    call registerobssetup(trim(LVT_ARMobsId)//char(0), ARM_obsinit)
    call registerobsread(trim(LVT_ARMobsId)//char(0), readARMObs)

    call registerobssetup(trim(LVT_SMOSREXobsId)//char(0), &
         SMOSREX_obsinit)
    call registerobsread(trim(LVT_SMOSREXobsId)//char(0), readSMOSREXObs)

    call registerobssetup(trim(LVT_AGRMETdataId)//char(0), &
         AGRMET_datainit)
    call registerobsread(trim(LVT_AGRMETdataId)//char(0), &
         readAGRMETdata)

    call registerobssetup(trim(LVT_GlobSnowObsId)//char(0), &
         GlobSnow_obsinit)
    call registerobsread(trim(LVT_GlobSnowObsId)//char(0), &
         readGlobSnowObs)

    call registerobssetup(trim(LVT_SNODEPmetObsId)//char(0), &
         SNODEP_metobsinit)
    call registerobsread(trim(LVT_SNODEPmetObsId)//char(0), &
         readSNODEPmetObs)
    ...
    call registerobssetup(trim(LVT_MOD10A1obsId)//char(0), &
         MOD10A1_obsinit)
    call registerobsread(trim(LVT_MOD10A1obsId)//char(0), readMOD10A1obs)

    call registerobssetup(trim(LVT_MODSCAGobsId)//char(0), &
         MODSCAG_obsinit)
    call registerobsread(trim(LVT_MODSCAGobsId)//char(0), readMODSCAGobs)

    call registerobssetup(trim(LVT_MOD10A1V6obsId)//char(0), &
         MOD10A1V6_obsinit)
    call registerobsread(trim(LVT_MOD10A1V6obsId)//char(0), &
         readMOD10A1V6obs)

    call registerobssetup(trim(LVT_ANSASNWDobsId)//char(0), &
         ANSASNWD_obsinit)
    call registerobsread(trim(LVT_ANSASNWDobsId)//char(0), &
         readANSASNWDobs)

    call registerobssetup(trim(LVT_ANSASWEobsId)//char(0), &
         ANSASWE_obsinit)
    call registerobsread(trim(LVT_ANSASWEobsId)//char(0), readANSASWEobs)

    call registerobssetup(trim(LVT_CPCPRCPobsId)//char(0), &
         CPCPRCP_obsinit)
    ...
    call registerobssetup(trim(LVT_MOD16A2obsId)//char(0), &
         MOD16A2_obsinit)
    ...
    call registerobssetup(trim(LVT_ALEXIesiobsId)//char(0), &
         ALEXIesi_obsinit)
    call registerobsread(trim(LVT_ALEXIesiobsId)//char(0), &
         readALEXIesiobs)
    ...
    call registerobssetup(trim(LVT_simGRACEobsId)//char(0), &
         simGRACE_obsinit)
    call registerobsread(trim(LVT_simGRACEobsId)//char(0), &
         readsimGRACEObs)

    call registerobssetup(trim(LVT_USGSGWwellobsId)//char(0), &
         USGSGWwell_obsinit)
    call registerobsread(trim(LVT_USGSGWwellobsId)//char(0), &
         readUSGSGWwellobs)
    ...
    call registerobssetup(trim(LVT_SMOSL2smobsId)//char(0), &
         SMOSL2sm_obsinit)
    call registerobsread(trim(LVT_SMOSL2smobsId)//char(0), &
         readSMOSL2smobs)
    ...
    call registerobssetup(trim(LVT_SMOSL1TBobsId)//char(0), &
         SMOSL1TB_obsinit)
    call registerobsread(trim(LVT_SMOSL1TBobsId)//char(0), &
         readSMOSL1TBobs)
    ...
    call registerobssetup(trim(LVT_CMORPHdataId)//char(0), &
         CMORPH_datainit)
    call registerobsread(trim(LVT_CMORPHdataId)//char(0), readCMORPHdata)

    call registerobssetup(trim(LVT_CHIRPSv2dataId)//char(0), &
         CHIRPSv2_datainit)
    call registerobsread(trim(LVT_CHIRPSv2dataId)//char(0), &
         readCHIRPSv2data)

    call registerobssetup(trim(LVT_USCRNsmdataId)//char(0), &
         USCRNsm_obsinit)
    ...
    call registerobssetup(trim(LVT_IMDPRCPdataId)//char(0), &
         IMDPRCP_obsinit)
    call registerobsread(trim(LVT_IMDPRCPdataId)//char(0), &
         readIMDPRCPobs)

    call registerobssetup(trim(LVT_APHROPRCPdataId)//char(0), &
         APHROPRCP_obsinit)
    call registerobsread(trim(LVT_APHROPRCPdataId)//char(0), &
         readAPHROPRCPobs)
    ...
    call registerobssetup(trim(LVT_GLASSlaiobsId)//char(0), &
         GLASSlaiobsinit)
    call registerobsread(trim(LVT_GLASSlaiobsId)//char(0), &
         readGLASSlaiobs)

    call registerobssetup(trim(LVT_GLASSalbedoobsId)//char(0), &
         GLASSalbedoobsinit)
    call registerobsread(trim(LVT_GLASSalbedoobsId)//char(0), &
         readGLASSalbedoobs)
