...
!BOP
! 
! !ROUTINE: upscaleByAveraging_input_with_latlon
! \label{upscaleByAveraging_input_with_latlon}
!
! !INTERFACE:    
subroutine upscaleByAveraging_input_with_latlon (gridDesci,gridDesco,mi,mo,& 
     n11, rlat, rlon)
...
!     call compute_earth_coord(gridDesci,mi,fill, xpts, ypts, rlon, rlat, nv)
!  endif
...
end subroutine upscaleByAveraging_input_with_latlon
