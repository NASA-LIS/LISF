...
#------------------------------------------------------------------------------
#
# SCRIPT: run_lvt_sm_anomaly_noah39_hpc11.sh
#
# PURPOSE: Run LVT in a batch job on HPC11, to update 00Z Noah39 soil moisture
...
lvtconfig=configs/lvt.config.template_sm_anomaly_noah39
