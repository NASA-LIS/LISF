...
#--------------------------------------------------------------------------
#
# SCRIPT: make_lvt_config_snippost.py
#
# PURPOSE: Reads template lvt.config file for running LVT in SNIPpost mode,
...
def _usage():
    ...
    print("    YYYYMMDDHH is valid date/time of SNIP analysis in UTC")
...
def _main():
    ...
    # Open the template lvt.config file, read in the contents, and update
    # as needed.
    ...
    newline = "lvt.config.foc.snippost.76"
