...
! NASA Goddard Space Flight Center Land Information System (LVT)
!
! See RELEASE_NOTES.txt for more information.
!
! The LVT source code and documentation are not in the public domain
...
! regarding the release of the LVT software.
!
