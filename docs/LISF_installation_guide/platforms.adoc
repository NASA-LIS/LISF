...
// narwhal (lisf_7.6_prgenv_cray_8.3.3)
...
.Cray/SUSE Linux Enterprise Server 15.4 and 15.5
|====
| Library        | Version
...
// hpc11 (lisf_7.6_prgenv_cray_8.6.0_cpe_25.03_cce_19.0.0)
.Cray/SUSE Linux Enterprise Server 15.6
|====
| Library        | Version

| GNU compiler   | 7.5.0
| Cray compiler  | 19.0.0
| Cray MPI       | 8.1.32
| HDF 5          | 1.14.6
| NetCDF         | 4.9.3
