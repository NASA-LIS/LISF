...
The tar files used in this walkthrough are available on the {url-lis-testcases-data}[LIS Testcase website]. From within your `$WORKING_DIR`, download and unpack the compressed tar file containing the inputs and target outputs for {step-label}:
