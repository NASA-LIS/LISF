...
Landmask resolution (dy):        0.01
 ...
 \var{Lakecover data source:} specifies the data source for lake depth and/or
...
Lakecover data source:       GLDBv1
 ...
 \var{Lake depth map:} specifies the location of the lake depth file
...
Lake depth map:        ./flake_inputs/GlobalLakeDepth.dat  
 ...
 \var{Lake depth QC map:} is a file that specifies the location
...
Lake depth QC map:     ./flake_inputs/GlobalLakeStatus.dat   
 ...
 \var{Lake params spatial transform:} indicates which spatial transform
...
Lake params spatial transform:    average
 ...
 \var{Lake wind fetch value:} is the user-specified input value 
...
Lake wind fetch value:         10000.                
 ...
 \var{Lake bottom sediments depth value:} is the user-specified
...
Lake bottom sediments depth value:  10.                  
 ...
 \var{Lake bottom sediments temperature value:} is the user-specified
...
Lake bottom sediments temperature value:   277.13
 ...
 \var{Inland waterbody data source:} specifies the inland water body
...
Inland waterbody data source:      GLWD
 ...
 \var{Inland waterbody type map:} specifies the inland water body
 map file and path.
...
Inland waterbody type map:  ./inlandwater_parms/GLWD/rastert_glwd_31.flt
 ...
 \var{Inland waterbody spatial transform:} specifies the inland
...
Irrigation fraction spatial transform:     none
 ...
 \var{Gravel fraction map:} specifies the gravel map file.
 ...
 \var{Quartz map:} specifies quartz data map file.
...
SNOW17 map projection:               hrap
 ...
 \var{SiB2 static parameter directory:} specifies the location of 
 ...
 \var{SiB2 parameter spatial transform:} specifies the general grid
 spatial transform option for SiB2.  Only current option
 for now is ``none''.

 \var{SiB2 map projection:} specfies the general SiB2 parameter
  map projection.  \\attention{What projections are available?}

 \var{SiB2 parameter fill option:} specifies the general SiB2
 parameter fill option.

 \var{SiB2 parameter fill radius:} specifies the radius with which
 to search for nearby value(s) to help fill in the missing value.

 \var{SiB2 parameter fill value:} indicates which SiB2 parameter
 value to be used if an arbitrary value fill is needed. 
...
PPT climatology interval:     monthly
 ...
 \var{TMIN climatology maps:} specifies the source of the climatology
 based minimum temperature files.

 \var{TMAX climatology maps:} specifies the source of the climatology
