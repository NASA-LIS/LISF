...
!BOP
! !ROUTINE: timeinterp_WRFout
! \label{timeinterp_WRFout}
!
! !REVISION HISTORY:
!
! !INTERFACE:
subroutine timeinterp_WRFout(n, findex)
! !USES:
  use ESMF
...
!EOP
  ...
  btime=WRFout_struc(n)%WRFouttime1
  ...
  btime=WRFout_struc(n)%WRFouttime2
...
!=== Interpolate Data in time      
  wt1=(WRFout_struc(n)%WRFouttime2-LIS_rc%time)/ & 
      (WRFout_struc(n)%WRFouttime2-WRFout_struc(n)%WRFouttime1)
  wt2=1.0-wt1
  ...
  do t=1,LIS_rc%ntiles(n)
     ...
     if(WRFout_struc(n)%metdata1(3,index1).ne.LIS_rc%udef .and. &
        WRFout_struc(n)%metdata2(3,index1).ne.LIS_rc%udef) then 
        swd(t) = WRFout_struc(n)%metdata1(3,index1)*zw1+&
                 WRFout_struc(n)%metdata2(3,index1)*zw2
!       In cases of small cos(zenith) angles, use linear weighting
!       to avoid overly large weights

        if((swd(t).gt.WRFout_struc(n)%metdata1(3,index1)  .and. & 
            swd(t).gt.WRFout_struc(n)%metdata2(3,index1)) .and. & 
           (czb.lt.0.1.or.cze.lt.0.1))then
           swd(t) = WRFout_struc(n)%metdata1(3,index1)*swt1 + & 
                    WRFout_struc(n)%metdata2(3,index1)*swt2
        endif
     endif
     ...
     if (swd(t).gt.LIS_CONST_SOLAR) then
        ...
        write(unit=LIS_logunit,fmt=*)'[WARN] data1=',WRFout_struc(n)%metdata1(3,index1)
        write(unit=LIS_logunit,fmt=*)'[WARN] data2=',WRFout_struc(n)%metdata2(3,index1)
...
!        write(unit=LIS_logunit,fmt=*)'forcing set to ',swd(t) 
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if( (WRFout_struc(n)%metdata1(8,index1).ne.LIS_rc%udef) .and. &
         (WRFout_struc(n)%metdata2(8,index1).ne.LIS_rc%udef) ) then 
        pcp(t) = WRFout_struc(n)%metdata2(8,index1) - &
                 WRFout_struc(n)%metdata1(8,index1)
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if((WRFout_struc(n)%metdata1(1,index1).ne.LIS_rc%udef) .and. &
        (WRFout_struc(n)%metdata2(1,index1).ne.LIS_rc%udef)) then 
        tmp(t) = WRFout_struc(n)%metdata1(1,index1)*wt1 + & 
                 WRFout_struc(n)%metdata2(1,index1)*wt2
     endif
  enddo
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if((WRFout_struc(n)%metdata1(2,index1).ne.LIS_rc%udef) .and. &
        (WRFout_struc(n)%metdata2(2,index1).ne.LIS_rc%udef)) then 
        q2(t) = WRFout_struc(n)%metdata1(2,index1)*wt1 + & 
                WRFout_struc(n)%metdata2(2,index1)*wt2
     endif
  enddo
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if((WRFout_struc(n)%metdata1(4,index1).ne.LIS_rc%udef) .and. &
        (WRFout_struc(n)%metdata2(4,index1).ne.LIS_rc%udef)) then 
        lwd(t) = WRFout_struc(n)%metdata1(4,index1)*wt1 + & 
                 WRFout_struc(n)%metdata2(4,index1)*wt2
     endif
  enddo
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if((WRFout_struc(n)%metdata1(5,index1).ne.LIS_rc%udef) .and. &
        (WRFout_struc(n)%metdata2(5,index1).ne.LIS_rc%udef)) then 
        uwind(t) = WRFout_struc(n)%metdata1(5,index1)*wt1 + & 
                   WRFout_struc(n)%metdata2(5,index1)*wt2
     endif
  enddo
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if((WRFout_struc(n)%metdata1(6,index1).ne.LIS_rc%udef) .and. &
        (WRFout_struc(n)%metdata2(6,index1).ne.LIS_rc%udef)) then 
        vwind(t) = WRFout_struc(n)%metdata1(6,index1)*wt1 + & 
                   WRFout_struc(n)%metdata2(6,index1)*wt2
     endif
  enddo
  ...
  do t=1,LIS_rc%ntiles(n)
     index1 = LIS_domain(n)%tile(t)%index 
     if((WRFout_struc(n)%metdata1(7,index1).ne.LIS_rc%udef) .and. &
        (WRFout_struc(n)%metdata2(7,index1).ne.LIS_rc%udef)) then 
        psurf(t) = WRFout_struc(n)%metdata1(7,index1)*wt1 + & 
                   WRFout_struc(n)%metdata2(7,index1)*wt2
     endif
  enddo
  ...
  if ( forcing_z ) then
     ...
     do t=1,LIS_rc%ntiles(n)
        index1 = LIS_domain(n)%tile(t)%index 
        if((WRFout_struc(n)%metdata1(10,index1).ne.LIS_rc%udef) .and. &
           (WRFout_struc(n)%metdata2(10,index1).ne.LIS_rc%udef)) then 
           fheight(t) = WRFout_struc(n)%metdata1(10,index1)*wt1 + & 
                        WRFout_struc(n)%metdata2(10,index1)*wt2
        endif
     enddo
  endif
  ...
  if ( forcing_ch ) then
     ...
     do t=1,LIS_rc%ntiles(n)
        index1 = LIS_domain(n)%tile(t)%index 
        if((WRFout_struc(n)%metdata1(11,index1).ne.LIS_rc%udef) .and. &
           (WRFout_struc(n)%metdata2(11,index1).ne.LIS_rc%udef)) then 
           acond(t) = WRFout_struc(n)%metdata1(11,index1)*wt1 + & 
                      WRFout_struc(n)%metdata2(11,index1)*wt2
        endif
     enddo
  endif
...
end subroutine timeinterp_WRFout
