...
!BOP
!
! !ROUTINE: timeinterp_capa
! \label{timeinterp_capa}
! 
! !REVISION HISTORY: 
! 23 Nov 2009: Sujay Kumar, Initial Specification
!
! !INTERFACE:
  subroutine timeinterp_capa(n,findex)
! !USES:
    use ESMF
...
!EOP
    ...
    do t=1,LIS_rc%ntiles(n)
       ...
       if ( capa_struc(n)%metdata2(1,index1) /= LIS_rc%udef ) then  
          pcp(t) = capa_struc(n)%metdata2(1,index1) / (6*3600.0)
       endif
    enddo
  end subroutine timeinterp_capa
