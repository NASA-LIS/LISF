...
!
! !INTERFACE: 
subroutine interp_stg2 (n, findex, nstg2, ppt_field, lb, lis_gds, &
                        nc, nr, varfield )
...
! == BUDGET BILINEAR INTERPOLATION ==== 
       call conserv_interp( lis_gds, lb, ppt_field, lo, &
            ...
            stg2_struc(n)%n212, stg2_struc(n)%n222,LIS_rc%udef,iret)
  endif
