...
!BOP
! !ROUTINE: vic412_read_gridded_forcing_data
! \label{vic412_read_gridded_forcing_data}
!
! !INTERFACE:
subroutine vic412_read_gridded_forcing_data(n, findex, filename, ferror)
! !USES:
...
end subroutine vic412_read_gridded_forcing_data
