...
#include "LIS_misc.h"
!BOP
! !MODULE: pptEnsFcst_SpatialInterpMod
! \label{pptEnsFcst_SpatialInterpMod}
! 
! !DESCRIPTION: 
...
!------------------------------------------------------------------------------
  public :: pptEnsFcst_interp_init      ! initialize interp routine inputs/outputs
  public :: pptEnsFcst_interp_data      ! transform input data/field to LIS target grid
  public :: pptEnsFcst_interp_finalize  ! deallocate/reinit any interp arrays/inputs
!EOP
...
!BOP
! !ROUTINE: pptEnsFcst_interp_init 
!  \label{pptEnsFcst_interp_init}
! 
! !INTERFACE: 
!
 subroutine pptEnsFcst_interp_init( n, findex, input_gridDesc )
!
! !USES: 
...
!- Determine if reprojection option:
 ...
 end subroutine pptEnsFcst_interp_init


!BOP
! !ROUTINE: pptEnsFcst_interp_data
!  \label{pptEnsFcst_interp_data}
! 
! !INTERFACE: 
!
 subroutine pptEnsFcst_interp_data( n, findex,  &
...
!   end do    ! End field time loop
 ...
 end subroutine pptEnsFcst_interp_data


!BOP
! !ROUTINE: pptEnsFcst_interp_finalize
!  \label{pptEnsFcst_interp_finalize}
! 
! !INTERFACE: 
!
 subroutine pptEnsFcst_interp_finalize( findex )
!
! !USES: 
   use LIS_coreMod, only : LIS_rc, LIS_domain
   use LIS_logMod,  only : LIS_logunit, LIS_endrun
 ...
 end subroutine pptEnsFcst_interp_finalize

end module pptEnsFcst_SpatialInterpMod
