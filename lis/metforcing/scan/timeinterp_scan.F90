...
!BOP
!
! !ROUTINE: timeinterp_scan
! \label{timeinterp_scan}
! 
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine timeinterp_scan(n, findex)
! !USES:
  use ESMF
...
!EOP
  ...
  do t = 1,LIS_rc%ntiles(n)
     ...
     if((scan_struc(n)%metdata2(1,index1) &
          .ne.scan_struc(n)%undef)) then  
        pcp(t)= scan_struc(n)%metdata2(1,index1)
     endif
  enddo
end subroutine timeinterp_scan
