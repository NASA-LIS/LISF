...
!EOP
  type, public ::  hmaens_type_dec
     ...
     real         :: ts
     integer      :: ncold, nrold
     character*100 :: hmaensdir   !HMAENS Forcing Directory
...
!       hmaens_struc(n)%mo2 = -1
       ...
       allocate(hmaens_struc(n)%tair1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%qair1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%wind1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%ps1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%prec1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%swd1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%lwd1(LIS_rc%lnc(n)*LIS_rc%lnr(n)))

       allocate(hmaens_struc(n)%tair2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%qair2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%wind2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%ps2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%prec2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%swd2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
       allocate(hmaens_struc(n)%lwd2(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
