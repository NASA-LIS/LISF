...
!BOP
! 
! !ROUTINE: write_SMOSNRTNNL2smobs
! \label{write_SMOSNRTNNL2smobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 20 Jan 2021: Yonghwan Kwon; Updated to write SMOS NRT NN L2 soil moisture  
!
! !INTERFACE:
subroutine write_SMOSNRTNNL2smobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then
     ...
     if(LIS_masterproc) then
        ...
        call SMOSNRTNNL2_smobsname(n,k,obsname)
...
end subroutine write_SMOSNRTNNL2smobs

!BOP
! !ROUTINE: SMOSNRTNNL2_smobsname
! \label{SMOSNRTNNL2_smobsname}
! 
! !INTERFACE: 
subroutine SMOSNRTNNL2_smobsname(n,k,obsname)
! !USES: 
...
end subroutine SMOSNRTNNL2_smobsname
