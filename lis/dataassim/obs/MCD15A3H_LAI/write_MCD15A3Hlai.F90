...
!BOP
! 
! !ROUTINE: write_MCD15A3Hlai
! \label{write_MCD15A3Hlai}
! 
! !REVISION HISTORY: 
!  30 Oct 2023    Wanshu Nie; initial specification
! 
! !INTERFACE: 
subroutine write_MCD15A3Hlai(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
! MCD15A3H LAI observations to a file
! 
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call MCD15A3H_laiobsname(n,k,obsname)        
...
end subroutine write_MCD15A3Hlai

!BOP
! !ROUTINE: MCD15A3H_laiobsname
! \label{MCD15A3H_laiobsname}
! 
! !INTERFACE: 
subroutine MCD15A3H_laiobsname(n,k,obsname)
! !USES: 
...
end subroutine MCD15A3H_laiobsname
