...
! 
! !INTERFACE: 
subroutine write_THySM(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call THySM_obsname(n,k,obsname)        
...
end subroutine write_THySM

!BOP
! !ROUTINE: THySM_obsname
! \label{THySM_obsname}
! 
! !INTERFACE: 
subroutine THySM_obsname(n,k,obsname)
! !USES: 
