...
!BOP
! 
! !ROUTINE: write_ANSASCFsnowobs
! \label{write_ANSASCFsnowobs}
! 
! !REVISION HISTORY: 
! 1 Jun 2009: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_ANSASCFsnowobs(n, OBS_State)
! !USES: 
  use ESMF
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call ANSASCFsnow_obsname(obsname)        
...
end subroutine write_ANSASCFsnowobs

!BOP
! !ROUTINE: ANSASCFsnow_obsname
! \label{ANSASCFsnow_obsname}
! 
! !INTERFACE: 
subroutine ANSASCFsnow_obsname(obsname)
! !USES: 
...
end subroutine ANSASCFsnow_obsname
