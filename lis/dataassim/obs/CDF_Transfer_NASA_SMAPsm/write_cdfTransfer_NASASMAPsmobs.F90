...
!BOP
! 
! !ROUTINE: write_cdfTransfer_NASASMAPsmobs
! \label{write_cdfTransfer_NASASMAPsmobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 2 Mar 2022: Mahdi navari; modified for cdf transfer DA
! 
! !INTERFACE: 
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call cdfTransfer_smobsname(n,k,obsname)        
...
end subroutine write_cdfTransfer_NASASMAPsmobs

!BOP
! !ROUTINE: cdfTransfer_smobsname
! \label{cdfTransfer_smobsname}
! 
! !INTERFACE: 
subroutine cdfTransfer_smobsname(n,k,obsname)
! !USES: 
...
end subroutine cdfTransfer_smobsname
