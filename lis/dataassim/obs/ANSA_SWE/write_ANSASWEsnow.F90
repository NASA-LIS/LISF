...
!BOP
! 
! !ROUTINE: write_ANSASWEsnowobs
! \label{write_ANSASWEsnowobs}
! 
! !REVISION HISTORY: 
! 1 Jun 2009: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_ANSASWEsnowobs(n, OBS_State)
! !USES: 
  use ESMF
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call ANSASWEsnow_obsname(obsname)        
...
end subroutine write_ANSASWEsnowobs

!BOP
! !ROUTINE: ANSASWEsnow_obsname
! \label{ANSASWEsnow_obsname}
! 
! !INTERFACE: 
subroutine ANSASWEsnow_obsname(obsname)
! !USES: 
...
end subroutine ANSASWEsnow_obsname
