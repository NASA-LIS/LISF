...
!BOP
! 
! !ROUTINE: write_GCOMW_AMSR2L3smobs
! \label{write_GCOMW_AMSR2L3smobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_GCOMW_AMSR2L3smobs(n, OBS_State)
! !USES: 
  use ESMF
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call GCOMW_AMSR2_smobsname(obsname)        
...
end subroutine write_GCOMW_AMSR2L3smobs

!BOP
! !ROUTINE: GCOMW_AMSR2_smobsname
! \label{GCOMW_AMSR2_smobsname}
! 
! !INTERFACE: 
subroutine GCOMW_AMSR2_smobsname(obsname)
! !USES: 
...
end subroutine GCOMW_AMSR2_smobsname
