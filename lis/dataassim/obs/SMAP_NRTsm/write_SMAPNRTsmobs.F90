...
!BOP
! 
! !ROUTINE: write_SMAPNRTsmobs
! \label{write_SMAPNRTsmobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_SMAPNRTsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call NASASMAPNRT_smobsname(n,k,obsname)        
...
end subroutine write_SMAPNRTsmobs

!BOP
! !ROUTINE: NASASMAPNRT_smobsname
! \label{NASASMAPNRT_smobsname}
! 
! !INTERFACE: 
subroutine NASASMAPNRT_smobsname(n,k,obsname)
! !USES: 
...
end subroutine NASASMAPNRT_smobsname
