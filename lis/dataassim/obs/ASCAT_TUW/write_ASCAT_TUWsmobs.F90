...
!BOP
! 
! !ROUTINE: write_ASCAT_TUWsmobs
! \label{write_ASCAT_TUWsmobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_ASCAT_TUWsmobs(n, OBS_State)
! !USES: 
  use ESMF
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call ASCAT_TUW_smobsname(obsname)        
...
end subroutine write_ASCAT_TUWsmobs

!BOP
! !ROUTINE: ASCAT_TUW_smobsname
! \label{ASCAT_TUW_smobsname}
! 
! !INTERFACE: 
subroutine ASCAT_TUW_smobsname(obsname)
! !USES: 
...
end subroutine ASCAT_TUW_smobsname
