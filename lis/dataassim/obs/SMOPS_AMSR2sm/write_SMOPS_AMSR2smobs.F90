...
!BOP
! 
! !ROUTINE: write_SMOPS_AMSR2smobs
! \label{write_SMOPS_AMSR2smobs}
! 
! !REVISION HISTORY: 
...
! 
! !INTERFACE: 
subroutine write_SMOPS_AMSR2smobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SMOPS_AMSR2smobsname(n,k,obsname)        
...
end subroutine write_SMOPS_AMSR2smobs

!BOP
! !ROUTINE: SMOPS_AMSR2smobsname
! \label{SMOPS_AMSR2smobsname}
! 
! !INTERFACE: 
subroutine SMOPS_AMSR2smobsname(n,k,obsname)
! !USES: 
...
end subroutine SMOPS_AMSR2smobsname
