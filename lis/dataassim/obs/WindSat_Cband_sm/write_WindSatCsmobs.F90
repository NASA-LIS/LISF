...
!BOP
! 
! !ROUTINE: write_WindSatCsmobs
! \label{write_WindSatCsmobs}
! 
! !REVISION HISTORY: 
! 22 Dec 2009: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_WindSatCsmobs(n, OBS_State)
! !USES: 
  use ESMF
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call WindSat_Csmobsname(obsname)        
...
end subroutine write_WindSatCsmobs

!BOP
! !ROUTINE: WindSat_Csmobsname
! \label{WindSat_Csmobsname}
! 
! !INTERFACE: 
subroutine WindSat_Csmobsname(obsname)
! !USES: 
...
end subroutine WindSat_Csmobsname
