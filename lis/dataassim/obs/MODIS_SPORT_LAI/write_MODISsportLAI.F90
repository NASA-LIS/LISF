...
!BOP
! 
! !ROUTINE: write_MODISsportLAI
! \label{write_MODISsportLAI}
! 
! !REVISION HISTORY: 
!  21 Dec 2017    Sujay Kumar; initial specification
! 
! !INTERFACE: 
subroutine write_MODISsportLAI(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call MODISsport_laiobsname(n,k,obsname)        
...
end subroutine write_MODISsportLAI

!BOP
! !ROUTINE: MODISsport_laiobsname
! \label{MODISsport_laiobsname}
! 
! !INTERFACE: 
subroutine MODISsport_laiobsname(n,k,obsname)
! !USES: 
...
end subroutine MODISsport_laiobsname
