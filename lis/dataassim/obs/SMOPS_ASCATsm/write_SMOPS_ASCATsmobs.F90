...
!BOP
! 
! !ROUTINE: write_SMOPS_ASCATsmobs
! \label{write_SMOPS_ASCATsmobs}
! 
! !REVISION HISTORY: 
...
! 
! !INTERFACE: 
subroutine write_SMOPS_ASCATsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SMOPS_ASCATsmobsname(n,k,obsname)        
...
end subroutine write_SMOPS_ASCATsmobs

!BOP
! !ROUTINE: SMOPS_ASCATsmobsname
! \label{SMOPS_ASCATsmobsname}
! 
! !INTERFACE: 
subroutine SMOPS_ASCATsmobsname(n,k,obsname)
! !USES: 
...
end subroutine SMOPS_ASCATsmobsname
