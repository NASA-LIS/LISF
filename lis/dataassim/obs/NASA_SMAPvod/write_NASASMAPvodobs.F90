...
!BOP
! 
! !ROUTINE: write_NASASMAPvodobs
! \label{write_NASASMAPvodobs}
! 
! !REVISION HISTORY: 
! 28 Mar 2019: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_NASASMAPvodobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
! SMAP VOD observations to a file
! 
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call NASASMAP_vodobsname(n,k,obsname)        
...
end subroutine write_NASASMAPvodobs

!BOP
! !ROUTINE: NASASMAP_vodobsname
! \label{NASASMAP_vodobsname}
! 
! !INTERFACE: 
subroutine NASASMAP_vodobsname(n,k,obsname)
! !USES: 
...
end subroutine NASASMAP_vodobsname
