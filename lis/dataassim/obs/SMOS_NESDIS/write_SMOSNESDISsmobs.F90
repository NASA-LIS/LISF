...
!BOP
! 
! !ROUTINE: write_SMOSNESDISsmobs
! \label{write_SMOSNESDISsmobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_SMOSNESDISsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SMOSNESDIS_smobsname(n,k,obsname)        
...
end subroutine write_SMOSNESDISsmobs

!BOP
! !ROUTINE: SMOSNESDIS_smobsname
! \label{SMOSNESDIS_smobsname}
! 
! !INTERFACE: 
subroutine SMOSNESDIS_smobsname(n,k,obsname)
! !USES: 
...
end subroutine SMOSNESDIS_smobsname
