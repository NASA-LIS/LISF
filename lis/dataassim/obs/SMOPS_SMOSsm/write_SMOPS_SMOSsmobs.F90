...
!BOP
! 
! !ROUTINE: write_SMOPS_SMOSsmobs
! \label{write_SMOPS_SMOSsmobs}
! 
! !REVISION HISTORY: 
...
! 
! !INTERFACE: 
subroutine write_SMOPS_SMOSsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SMOPS_SMOSsmobsname(n,k,obsname)        
...
end subroutine write_SMOPS_SMOSsmobs

!BOP
! !ROUTINE: SMOPS_SMOSsmobsname
! \label{SMOPS_SMOSsmobsname}
! 
! !INTERFACE: 
subroutine SMOPS_SMOSsmobsname(n,k,obsname)
! !USES: 
...
end subroutine SMOPS_SMOSsmobsname
