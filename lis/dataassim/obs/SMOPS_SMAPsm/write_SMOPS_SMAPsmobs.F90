...
!BOP
! 
! !ROUTINE: write_SMOPS_SMAPsmobs
! \label{write_SMOPS_SMAPsmobs}
! 
! !REVISION HISTORY: 
...
! 
! !INTERFACE: 
subroutine write_SMOPS_SMAPsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SMOPS_SMAPsmobsname(n,k,obsname)        
...
end subroutine write_SMOPS_SMAPsmobs

!BOP
! !ROUTINE: SMOPS_SMAPsmobsname
! \label{SMOPS_SMAPsmobsname}
! 
! !INTERFACE: 
subroutine SMOPS_SMAPsmobsname(n,k,obsname)
! !USES: 
...
end subroutine SMOPS_SMAPsmobsname
