...
!BOP
! 
! !ROUTINE: write_SSMISNWDsnowobs
! \label{write_SSMISNWDsnowobs}
! 
! !REVISION HISTORY: 
! 16 Oct 2012: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_SSMISNWDsnowobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SSMISNWDsnow_obsname(n,k,obsname)        
...
end subroutine write_SSMISNWDsnowobs

!BOP
! !ROUTINE: SSMISNWDsnow_obsname
! \label{SSMISNWDsnow_obsname}
! 
! !INTERFACE: 
subroutine SSMISNWDsnow_obsname(n,k,obsname)
! !USES: 
...
end subroutine SSMISNWDsnow_obsname
