...
subroutine write_SNIPobs(n, k, OBS_State)
  ...
  logical                  :: data_update
  integer                  :: ftn
  character(LIS_CONST_PATH_LEN) :: obsname
...
end subroutine write_SNIPobs

! Construct output file name
subroutine SNIP_obsname(n, k, obsname)
