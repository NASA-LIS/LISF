...
!BOP
! 
! !ROUTINE: write_LPRM_AMSREsmobs
! \label{write_LPRM_AMSREsmobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_LPRM_AMSREsmobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call LPRM_AMSRE_smobsname(n,k,obsname)        
...
end subroutine write_LPRM_AMSREsmobs

!BOP
! !ROUTINE: LPRM_AMSRE_smobsname
! \label{LPRM_AMSRE_smobsname}
! 
! !INTERFACE: 
subroutine LPRM_AMSRE_smobsname(n,k,obsname)
! !USES: 
...
end subroutine LPRM_AMSRE_smobsname
