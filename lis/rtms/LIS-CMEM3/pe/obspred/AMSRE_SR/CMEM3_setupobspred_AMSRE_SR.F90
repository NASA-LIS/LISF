...
!BOP
! !ROUTINE: CMEM3_setupobspred_AMSRE_SR
!  \label{CMEM3_setupobspred_AMSRE_SR}
!
! !REVISION HISTORY:
! 16 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine CMEM3_setupobspred_AMSRE_SR(OBSPred)
! !USES:
  use ESMF
...
!EOP
  ...
  do f=1, numfreqs
     ...
     enddo
  enddo
end subroutine CMEM3_setupobspred_AMSRE_SR
