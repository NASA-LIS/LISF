...
MODULE CRTM_Surface_Define
  ...
  REAL(fp), PARAMETER :: DEFAULT_SOIL_TEMPERATURE      = 283.0_fp  ! K
    ! LIS added new vars (7/25/2011)
  REAL(fp),  PARAMETER :: DEFAULT_SIGMA                = 0.5_fp    !  roughness (cm) 
  REAL(fp),  PARAMETER :: DEFAULT_SAND                 = 0.8_fp    !  fraction
  REAL(fp),  PARAMETER :: DEFAULT_CLAY                 = 0.2_fp    !  fraction
  REAL(fp),  PARAMETER :: DEFAULT_LEAF_THICK           = 0.07_fp   ! mm 
  REAL(fp),  PARAMETER :: DEFAULT_LAI = DEFAULT_VEGETATION_FRACTION * 3.0_fp + 0.5_fp 
                                                                   ! NESDIS_LandEM
  REAL(fp),  PARAMETER :: DEFAULT_water_content_per_lai = 1.0_fp / 6.0_fp 
  REAL(fp),  PARAMETER :: DEFAULT_ssalb_factor          = 1.0_fp 
  ...
  TYPE :: CRTM_Surface_type
    ...
    ! LIS added new vars (7/25/2011)
    REAL(fp) :: sigma              = DEFAULT_SIGMA 
    REAL(fp) :: leaf_thick         = DEFAULT_LEAF_THICK
    REAL(fp) :: sand               = DEFAULT_SAND 
    REAL(fp) :: clay               = DEFAULT_CLAY 
    REAL(fp) :: lai                = DEFAULT_LAI 
    REAL(fp) :: water_content_per_lai    = DEFAULT_water_content_per_lai
    REAL(fp) :: ssalb_factor       = DEFAULT_ssalb_factor
