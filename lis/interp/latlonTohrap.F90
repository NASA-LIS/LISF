...
! 
! !INTERFACE:
subroutine latlontohrap(alat,along,xmeshl,orient,xi,xj)
...
!   coordinate system overlaid on a hrap map projection true at
!   60 degrees n or s latitude. 
!
!  The arguments are: 
!  \begin{description}
!  \item[alat]
