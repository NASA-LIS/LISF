...
!BOP
! !ROUTINE: write_USDA_ARS_sm_obs_data
! \label{write_USDA_ARS_sm_obs_data}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_USDA_ARS_sm_obs_data(Obj_Space)
!!$! !USES: 
  use ESMF
...
!!$  endif
!!$
end subroutine write_USDA_ARS_sm_obs_data

!BOP
! 
! !ROUTINE: USDA_ARS_obsname
! \label{USDA_ARS_obsname}
! 
! !INTERFACE: 
subroutine USDA_ARS_obsname(obsname)
! !USES: 
...
end subroutine USDA_ARS_obsname
