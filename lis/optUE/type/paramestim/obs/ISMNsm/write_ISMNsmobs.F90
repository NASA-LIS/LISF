...
!BOP
! !ROUTINE: write_ISMNsmobs
! \label{write_ISMNsmobs}
!
! !REVISION HISTORY:
!  21 Sep 2018: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_ISMNsmobs(Obj_Space)
! !USES: 
  use ESMF
...
! !DESCRIPTION:
!  
!  write the ISMN soil moisture data to disk
!  
!  The arguments are: 
!  \begin{description}
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call ISMNsm_obsname('smc',obsname)
...
end subroutine write_ISMNsmobs

!BOP
! 
! !ROUTINE: ISMNsm_obsname
! \label{ISMNsm_obsname}
! 
! !INTERFACE: 
subroutine ISMNsm_obsname(variabname, obsname)
! !USES: 
