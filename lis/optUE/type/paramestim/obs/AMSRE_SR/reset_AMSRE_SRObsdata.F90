...
!BOP
! !ROUTINE: reset_AMSRE_SR_em_obs_data
! \label{reset_AMSRE_SR_em_obs_data}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine reset_AMSRE_SR_em_obs_data(Obj_Space)
#if 0
! !USES: 
  use ESMF
...
#endif
end subroutine reset_AMSRE_SR_em_obs_data
