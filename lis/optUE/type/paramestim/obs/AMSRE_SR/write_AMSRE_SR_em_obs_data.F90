...
!BOP
! !ROUTINE: write_AMSRE_SR_em_obs_data
! \label{write_AMSRE_SR_em_obs_data}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_AMSRE_SR_em_obs_data(Obj_Space)
#if 0
! !USES: 
  use ESMF
...
#endif
end subroutine write_AMSRE_SR_em_obs_data

!BOP
! 
! !ROUTINE: AMSRE_SR_obsname
! \label{AMSRE_SR_obsname}
! 
! !INTERFACE: 
subroutine AMSRE_SR_obsname(obsname)
! !USES: 
...
end subroutine AMSRE_SR_obsname
