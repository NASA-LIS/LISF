...
!BOP
! !ROUTINE: write_Maconlsobsdata
! \label{write_Maconlsobsdata}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_Maconlsobsdata(Obj_Space)
! !USES: 
  use ESMF
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call macon_ls_outobsname(obsname)
...
end subroutine write_Maconlsobsdata

!BOP
! 
! !ROUTINE: macon_ls_outobsname
! \label{macon_ls_outobsname}
! 
! !INTERFACE: 
subroutine macon_ls_outobsname(outobsname)
! !USES: 
...
end subroutine macon_ls_outobsname
