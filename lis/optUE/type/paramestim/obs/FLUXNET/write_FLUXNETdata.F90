...
!BOP
! !ROUTINE: write_FLUXNETdata
! \label{write_FLUXNETdata}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_FLUXNETdata(Obj_Space)
! !USES: 
  use ESMF
...
end subroutine write_FLUXNETdata

!BOP
! 
! !ROUTINE: FLUXNETdata_obsname
! \label{FLUXNETdata_obsname}
! 
! !INTERFACE: 
subroutine FLUXNETdata_obsname(obsname)
! !USES: 
...
end subroutine FLUXNETdata_obsname
