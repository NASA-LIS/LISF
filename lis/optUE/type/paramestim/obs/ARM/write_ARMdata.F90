...
!
! !INTERFACE: 
subroutine write_ARMdata(Obj_Space)
! !USES: 
  use ESMF
...
end subroutine write_ARMdata

!BOP
! 
! !ROUTINE: ARMdata_obsname
! \label{ARMdata_obsname}
! 
! !INTERFACE: 
subroutine ARMdata_obsname(obsname)
! !USES: 
...
end subroutine ARMdata_obsname
