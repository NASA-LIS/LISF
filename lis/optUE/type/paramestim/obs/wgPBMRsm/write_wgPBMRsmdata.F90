...
!BOP
! !ROUTINE: write_wgPBMRsmdata
! \label{write_wgPBMRsmdata}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_wgPBMRsmdata(Obj_Space)
! !USES: 
  use ESMF
...
end subroutine write_wgPBMRsmdata

!BOP
! 
! !ROUTINE: wgPBMRsm_obsname
! \label{wgPBMRsm_obsname}
! 
! !INTERFACE: 
subroutine wgPBMRsm_obsname(obsname)
! !USES: 
...
end subroutine wgPBMRsm_obsname
