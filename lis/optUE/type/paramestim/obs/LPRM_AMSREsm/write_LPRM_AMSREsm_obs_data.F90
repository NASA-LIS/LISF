...
!BOP
! !ROUTINE: write_LPRM_AMSREsm_obs_data
! \label{write_LPRM_AMSREsm_obs_data}
!
! !REVISION HISTORY:
!  09 Jul 2009: Sujay Kumar; Initial Specification
!
! !INTERFACE: 
subroutine write_LPRM_AMSREsm_obs_data(Obj_Space)
#if 0
! !USES: 
  use ESMF
...
#endif
end subroutine write_LPRM_AMSREsm_obs_data
