...
// \begin{description}
// \item[j]
//   name of the domain/map projection
//  \end{description}
//EOP
{ 
  int len1;
...
{ 
  ...
  while(strcmp(current->name,j)!=0){
    ...
    if(current==NULL) {
      printf("****************Error****************************\n"); 
      printf("make domain routine for map projection %s is not defined\n",j); 
...
{ 
  ...
  while(strcmp(current->name,j)!=0){
    ...
    if(current==NULL) {
      printf("****************Error****************************\n"); 
      printf("read_input routine for map projection %s is not defined\n",j); 
      printf("program will seg fault.....\n"); 
      printf("****************Error****************************\n"); 
    }
  }
