...
!
! !INTERFACE: 
   subroutine LIS_readCDFdata(n, k, nbins, ntimes, ngrid, &
...
!        cdf = cdf_file
   ...
   end subroutine LIS_readCDFdata
...
!
! !INTERFACE: 
   subroutine LIS_readMeanSigmaData(n, k, ntimes, ngrid, filename, varname, mu, sigma)
...
!     sigma(:,:) = sigma_file(:,:,1)
   ...
   end subroutine LIS_readMeanSigmaData
