...
!EOP
        ...
        if(return_status .eq. 1) then
            ...
            if(rec2_len .eq. 16) then
                ...
                write(*,*) "xmrg_read_data: default no-data value (-1) is used when reading ", trim(xmrg_name)
                nodata_default = -1.0
            endif
...
!EOP
        ...
        real rlon, rlat, hrap_resolution, hrapx, hrapy, cell_size
...
!EOP
        ...
        real :: pi, d2rad, earthr, ref_lat, ref_lon, rlon2
        real :: rmesh, tlat, re, flat, flon, r, x, y 
        ...
        hrap_x = 0.01*floor(100*hrap_x+0.5)
        hrap_y = 0.01*floor(100*hrap_y+0.5)
