...
ydef 348 linear -11.75 0.1
zdef 1 linear 1 1
TDEF 1 LINEAR 06Z10jun2009 1dy
vars 38
...
LGP=>LGP 1 y,x description
WHC=>WHC 1 y,x description
SOS=>SOS 1 y,x description
SOSCLIM=>SOSCLIM 1 y,x description
SOSANOM=>SOSANOM 1 y,x description
WRSICLIM=>WRSICLIM 1 y,x description
WRSIMASK=>WRSIMASK 1 y,x description
