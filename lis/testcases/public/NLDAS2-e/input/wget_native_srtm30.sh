...
# Loop over each gridded tile and download *zip file:
  for nstile in n90 n40 s10; do
    for wetile in w180 w140 w100 w060 w020 e020 e060 e100 e140; do
       wget http://dds.cr.usgs.gov/srtm/version2_1/SRTM30/${wetile}${nstile}/${wetile}${nstile}.dem.zip -nv -a ${rundir}/download_srtm30native.log
       unzip ${wetile}${nstile}.dem.zip >> ${rundir}/download_srtm30native.log
    done
  done

# Obtain SRTM30 documentation and version release info:
  wget http://dds.cr.usgs.gov/srtm/version2_1/SRTM30/srtm30_documentation.pdf -nv -a ${rundir}/download_srtm30native.log
  wget http://dds.cr.usgs.gov/srtm/version2_1/SRTM30/srtm30_version_history.pdf -nv -a ${rundir}/download_srtm30native.log
