...
#
#  04.16.2017 -- James Geiger: v1.0: Initial version
#
### Necessary directory paths ###
 serverhost=https://portal.nccs.nasa.gov
 sourcedir=/lisdata_pub/data/TESTCASES/Public7.2/ESPconv
...
## Create directory structure:
   ...
   wget --no-check-certificate -r --accept "Public-LIS_ESPconv_output_v72-dev.tar.gz" -l1 -nv ${file} -nH --cut-dirs=5 -a download_output.log 

  echo " -----  COMPLETED DOWNLOADING FILES FOR:: " $sourcedir " -----  "
  echo " -----  UNZIPPING FILES FOR:: " $sourcedir " -----  "

  gzip -dc Public-LIS_ESPconv_output_v72-dev.tar.gz | tar xf -
