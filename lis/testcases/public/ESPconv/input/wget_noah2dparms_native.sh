...
# Download NLDAS Mask:
  cd ${rundir}
  mkdir -p ${targetdir}/NLDAS2
  cd ${targetdir}/NLDAS2
  wget --no-check-certificate https://portal.nccs.nasa.gov/lisdata_pub/data/PARAMETERS/NLDAS_0.125/umdmask_nldas.1gd4r
