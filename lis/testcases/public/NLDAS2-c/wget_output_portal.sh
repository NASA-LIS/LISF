...
### Necessary directory paths ###
 ...
 sourcedir=/lisdata_pub/data/TESTCASES/Public7.2/NLDAS2-c
  ...
  echo "== Downloading the sample output files for NLDAS2-c testcase == "
...
## Create directory structure:
   ...
   wget --no-check-certificate -r --accept "Public-RDHM-3.5.6_output_v72-dev.tar.gz" -l1 -nv ${file} -nH --cut-dirs=5 -a download_output.log 

  echo " -----  COMPLETED DOWNLOADING FILES FOR:: " $sourcedir " -----  "
  echo " -----  UNZIPPING FILES FOR:: " $sourcedir " -----  "

  gzip -dc Public-RDHM-3.5.6_output_v72-dev.tar.gz | tar xf -
