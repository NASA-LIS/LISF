...
#
# Settings for wgetting UMD STATSGO data files from the 
...
## Create directory structure:
   ...
   wget --no-check-certificate -r --accept "*?????STATSGO*" -l1 -nv ${file} -nH --cut-dirs=2 -a download_lisnoahparms.log # --http-user=$user --http-password=$pass
