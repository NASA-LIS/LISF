...
# pass=password
  ...
  echo "== Downloading the AMSRE emissivity obs for OPT/UE Public Testcase  == "
...
## Create directory structure:
   ...
   wget --no-check-certificate -r --accept "Public-OPTUE_input_v7.tar.gz" -l1 -nv ${file} -nH --cut-dirs=5 -a download_amsre_obs.log # --http-user=$user --http-password=$pass
...
### COMPLETED!! ###
  ...
  gzip -dc Public-OPTUE_input_v7.tar.gz | tar xf -
  rm Public-OPTUE_input_v7.tar.gz
