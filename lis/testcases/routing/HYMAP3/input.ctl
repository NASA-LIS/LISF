dset ^TARGET_OUTPUT/lis_input.nc
dtype netcdf
options template
undef -9999
...
HYMAP_node_lon=>HYMAP_node_lon 1 y,x description
HYMAP_node_lat=>HYMAP_node_lat 1 y,x description
HYMAP_runoff_bias_correction=>HYMAP_runoff_bias_correction 1 y,x description
ELEV_ERA5=>ELEV_ERA5 1 y,x description
