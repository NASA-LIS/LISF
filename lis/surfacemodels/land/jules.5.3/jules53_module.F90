...
module jules53_module
!BOP
!
! !MODULE: jules53_module.F90
!
! !DESCRIPTION:
!  Declare forcing-only option (jules53) variables
!
!  \begin{description}
!   \item[forcing]
...
!-------------------------------------------------------------------------
    ...
    real, allocatable :: p_s_clay_soilt(:)         !  Fraction of clay
