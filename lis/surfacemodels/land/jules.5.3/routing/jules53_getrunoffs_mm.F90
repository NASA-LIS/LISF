...
!BOP
! !ROUTINE: jules53_getrunoffs_mm
!  \label{jules53_getrunoffs_mm}
!
! !REVISION HISTORY:
! 1 May 2018: Sujay Kumar, Initial specification. 
!
! !INTERFACE:
subroutine jules53_getrunoffs_mm(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = jules53_struc(n)%jules53(t)%surf_roff
     runoff2(t) = jules53_struc(n)%jules53(t)%sub_surf_roff
  enddo
...
end subroutine jules53_getrunoffs_mm
