...
!BOP
! !ROUTINE: jules52_getrunoffs_mm
!  \label{jules52_getrunoffs_mm}
!
! !REVISION HISTORY:
! 1 May 2018: Sujay Kumar, Initial specification. 
!
! !INTERFACE:
subroutine jules52_getrunoffs_mm(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = jules52_struc(n)%jules52(t)%surf_roff
     runoff2(t) = jules52_struc(n)%jules52(t)%sub_surf_roff
  enddo
...
end subroutine jules52_getrunoffs_mm
