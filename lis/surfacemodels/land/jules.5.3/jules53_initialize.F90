...
!BOP
!
! !ROUTINE: jules53_initialize
! \label{jules53_initialize}
!
! !REVISION HISTORY:
!
! !INTERFACE:
subroutine jules53_initialize(mtype)
   ! !USES:
...
!EOP
   ...
   do n=1, LIS_rc%nnest
      write(LIS_logunit,*) "MSG: jules53_initialize -- initialzie for jules53"
      k = 1
      do
