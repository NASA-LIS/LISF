...
!BOP
! !ROUTINE: noahmp36_updatesnodepvars
! \label{noahmp36_updatesnodepvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp36_updatesnodepvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
end subroutine noahmp36_updatesnodepvars
