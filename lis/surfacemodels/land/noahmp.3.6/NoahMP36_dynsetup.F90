...
!BOP
!
! !ROUTINE: NoahMP36_dynsetup
! \label{NoahMP36_dynsetup}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine NoahMP36_dynsetup(n)
! !USES:
...
!
! !DESCRIPTION:
!  This routine sets up the time-dependent variables in NoahMP36
!
!EOP
    implicit none
    integer, intent(in) :: n
...
end subroutine NoahMP36_dynsetup
