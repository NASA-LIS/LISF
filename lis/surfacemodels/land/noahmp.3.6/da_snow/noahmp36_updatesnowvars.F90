...
!BOP
! !ROUTINE: noahmp36_updatesnowvars
! \label{noahmp36_updatesnowvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp36_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  enddo
end subroutine noahmp36_updatesnowvars
