...
!BOP
! !ROUTINE: noahmp36_updatesnowvarsSVM
! \label{noahmp36_updatesnowvarsSVM}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp36_updatesnowvarsSVM(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  enddo
end subroutine noahmp36_updatesnowvarsSVM
