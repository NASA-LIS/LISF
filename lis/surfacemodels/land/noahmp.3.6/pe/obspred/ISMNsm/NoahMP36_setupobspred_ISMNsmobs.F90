...
!BOP
! !ROUTINE: NoahMP36_setupobspred_ISMNsmobs
!  \label{NoahMP36_setupobspred_ISMNsmobs}
!
! !REVISION HISTORY:
! 2 Feb 2018: Soni Yatheendradas; Initial Specification
!
! !INTERFACE:
subroutine NoahMP36_setupobspred_ISMNsmobs(OBSPred)
! !USES:
  use ESMF
...
!  call LIS_verify(status)
end subroutine NoahMP36_setupobspred_ISMNsmobs
