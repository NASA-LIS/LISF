...
!BOP
! !ROUTINE: NoahMP36_getpeobspred_ARSsmobs
!  \label{NoahMP36_getpeobspred_ARSsmobs}
!
! !REVISION HISTORY:
! 02 Feb 2018: Soni Yatheendradas; Initial Specification
!
! !INTERFACE:
subroutine NoahMP36_getpeobspred_ARSsmobs(Obj_Func)
! !USES:
  use ESMF
...
!  write(LIS_logunit,*) '[INFO] Here 1 in NoahMP36_getpeobspred_ARSsmobs '
...
!  write(LIS_logunit,*) '[INFO] Here 2 in NoahMP36_getpeobspred_ARSsmobs '
...
!  write(LIS_logunit,*) '[INFO] Finished NoahMP36_getpeobspred_ARSsmobs, smc = ', smc

end subroutine NoahMP36_getpeobspred_ARSsmobs
