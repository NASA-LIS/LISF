...
!BOP
! !ROUTINE: noah36_getrunoffs
!  \label{noah36_getrunoffs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah36_getrunoffs(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = noah36_struc(n)%noah(t)%runoff1
     runoff2(t) = noah36_struc(n)%noah(t)%runoff2 
  enddo
...
end subroutine noah36_getrunoffs
