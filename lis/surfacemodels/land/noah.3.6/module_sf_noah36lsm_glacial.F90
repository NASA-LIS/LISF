...
MODULE module_sf_noah36lsm_glacial
  USE module_model_constants_36
  USE module_sf_noah36lsm, ONLY : RD, SIGMA, CPH2O, CPICE, LSUBF, EMISSI_S, ROSR12
...
CONTAINS
  ...
  SUBROUTINE SFLX_GLACIAL (ISICE,FFROZP,DT,ZLVL,NSOIL,SLDPTH,     &    !C
...
! ----------------------------------------------------------------------
    ...
    REAL, INTENT(IN)   :: DT,DQSDT2,LWDN,PRCP,     &
         ...
         &                SOLNET,TBOT,TH2,ZLVL,FFROZP,LVCOEF_DATA
    REAL               :: EMBRD, ALBEDO
    ...
    REAL               :: DF1,DSOIL,DTOT,FRCSNO,FRCSOI,          &
         ...
         &                T1V,T24,T2V,TH2V,TSNOW,Z0,PRCPF,RHO,TSOIL
...
!       CALL wrf_error_fatal ( 'Physical snow depth is less than snow water equiv.' )
       ! EMK NUWRF FIXME...Need generic stop method
...
! ----------------------------------------------------------------------
    ...
    CALL ALCALC (ALB,SNOALB,EMBRD,T1,ALBEDO,EMISSI,   &
         &       DT,SNOWNG,SNOTIME1,LVCOEF_DATA)
...
! ----------------------------------------------------------------------
  ...
  SUBROUTINE SNOPAC (ETP,ETA,PRCP,PRCPF,SNOWNG,NSOIL,DT,DF1,           &
       &             Q2,T1,SFCTMP,T24,TH2,FDOWN,SSOIL,STC,             &
       &             SFCPRS,RCH,RR,SNEQV,SNDENS,SNOWH,ZSOIL,TBOT,      &
       &             SNOMLT,DEW,FLX1,FLX2,FLX3,ESNOW,EMISSI,RIBB,YY)
...
END MODULE module_sf_noah36lsm_glacial
