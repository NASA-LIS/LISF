...
!BOP
! !ROUTINE: noah36_updatesnowvars
! \label{noah36_updatesnowvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah36_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
end subroutine noah36_updatesnowvars
