...
MODULE module_sf_noah33lsm_glacial
  USE module_model_constants_33
  USE module_sf_noah33lsm, ONLY : RD, SIGMA, CPH2O, CPICE, LSUBF, EMISSI_S, ROSR12
...
! ----------------------------------------------------------------------
    ...
    REAL,    PARAMETER     :: LVCOEF_DATA = 0.5
...
END MODULE module_sf_noah33lsm_glacial
