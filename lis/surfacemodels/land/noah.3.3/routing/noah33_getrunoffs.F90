...
!BOP
! !ROUTINE: noah33_getrunoffs
!  \label{noah33_getrunoffs}
!
! !REVISION HISTORY:
!  6 May 2011: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noah33_getrunoffs(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = noah33_struc(n)%noah(t)%runoff1
     runoff2(t) = noah33_struc(n)%noah(t)%runoff2 
  enddo
...
end subroutine noah33_getrunoffs
