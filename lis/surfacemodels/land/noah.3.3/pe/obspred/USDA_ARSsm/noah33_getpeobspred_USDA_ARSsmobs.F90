...
!BOP
! !ROUTINE: noah33_getpeobspred_USDA_ARSsmObs
!  \label{noah33_getpeobspred_USDA_ARSsmObs}
!
! !REVISION HISTORY:
! 06 Feb 2008: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noah33_getpeobspred_USDA_ARSsmObs(Obj_Func)
! !USES:
  use ESMF
...
!EOP
  ...
  call ESMF_StateGet(Obj_Func,"USDA ARS Surface Soil Moisture",sfsmField,rc=status)
...
end subroutine noah33_getpeobspred_USDA_ARSsmObs
