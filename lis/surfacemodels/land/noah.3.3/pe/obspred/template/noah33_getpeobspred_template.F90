...
!BOP
! !ROUTINE: noah33_getpeobspred_template
!  \label{noah33_getpeobspred_template}
!
! !REVISION HISTORY:
! 06 Feb 2008: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noah33_getpeobspred_template(Obj_Func)
! !USES:
  use ESMF
...
end subroutine noah33_getpeobspred_template
