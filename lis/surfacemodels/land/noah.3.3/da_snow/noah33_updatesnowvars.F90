...
!BOP
! !ROUTINE: noah33_updatesnowvars
! \label{noah33_updatesnowvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah33_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  enddo
end subroutine noah33_updatesnowvars
