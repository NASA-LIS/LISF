...
!BOP
! !ROUTINE: noah33_qc_snodepobs
! \label{noah33_qc_snodepobs}
!
! !REVISION HISTORY:
! 25Feb2008: Sujay Kumar: Initial Specification
!
! !INTERFACE:
subroutine noah33_qc_snodepobs(n,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!     if(noah33_struc(n)%noah(t)%shdfac.gt.0.7) then 
!        snodepobs(gid) = LIS_rc%udef        
!     endif
  enddo

end subroutine noah33_qc_snodepobs
