...
!
 ...
 MODULE module_model_constants_401
...
! for calls to set_tiles
 ...
 CONTAINS
   SUBROUTINE init_module_model_constants_401
   END SUBROUTINE init_module_model_constants_401
 END MODULE module_model_constants_401
