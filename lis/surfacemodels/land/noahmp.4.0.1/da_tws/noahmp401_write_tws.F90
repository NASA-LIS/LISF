...
!BOP
! !ROUTINE: noahmp401_write_tws
! \label{noahmp401_write_tws}
!
! !REVISION HISTORY:
! 14 Mar 2017: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noahmp401_write_tws(ftn,n, LSM_State)
...
!EOP
  ...
  !Wanshu
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     tmp(t) = NOAHMP401_struc(n)%noahmp401(t)%wa
  enddo
  call LIS_writevar_restart(ftn,n,1,tmp)
  !---------
  deallocate(tmp)

end subroutine noahmp401_write_tws
