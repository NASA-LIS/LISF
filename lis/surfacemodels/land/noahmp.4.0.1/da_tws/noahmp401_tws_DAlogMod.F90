...
module noahmp401_tws_DAlogMod
  
  use LIS_constantsMod,  only : LIS_CONST_RHOFW
  use ESMF
! !PUBLIC MEMBER FUNCTIONS:
!------------------------------------------
  public :: noahmp401_tws_DAlog
!-----------------------------------------
! !PUBLIC TYPES:
!-----------------------------------------
...
contains 
  ...
  subroutine noahmp401_tws_DAlog(n)
  ...
  end subroutine noahmp401_tws_DAlog
  
end module noahmp401_tws_DAlogMod
