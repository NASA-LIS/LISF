...
!BOP
! !ROUTINE: noahmp401_gettwspred
! \label{noahmp401_gettwspred}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_gettwspred(n, k,obs_pred)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
  use LIS_DAobservationsMod
  use noahmp401_tws_DAlogMod
...
!EOP
  ...
  call LIS_convertPatchSpaceToObsEnsSpace(n,k,&
       ...
       tws,&
       obs_pred)
end subroutine noahmp401_gettwspred
