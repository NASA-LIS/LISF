...
!  real                   :: SMCMAX , SMCWLT
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     if(NOAHMP401_struc(n)%noahmp401(t)%smc(1)+delta1.ge.MIN_THRESHOLD .and. &
        ...
        write(LIS_logunit,*) 'problem updating sm1 ', soilm1(t),NOAHMP401_struc(n)%noahmp401(t)%smc(1),NOAHMP401_struc(n)%noahmp401(t)%sh2o(1),MIN_THRESHOLD,sm_threshold
     ...
     if(NOAHMP401_struc(n)%noahmp401(t)%smc(2)+delta2.ge.MIN_THRESHOLD &
      .and. NOAHMP401_struc(n)%noahmp401(t)%smc(2)+delta2.lt.sm_threshold) then 
        ...
        update_flag(gid) = update_flag(gid).and.(.false.)
        update_flag_tile(t) = update_flag_tile(t).and.(.false.)
        write(LIS_logunit,*) 'problem updating sm2 ', soilm2(t),NOAHMP401_struc(n)%noahmp401(t)%smc(2),NOAHMP401_struc(n)%noahmp401(t)%sh2o(2),MIN_THRESHOLD,sm_threshold
     endif
     if(NOAHMP401_struc(n)%noahmp401(t)%smc(3)+delta3.ge.MIN_THRESHOLD .and.&
        ...
        update_flag(gid) = update_flag(gid).and.(.false.)
        update_flag_tile(t) = update_flag_tile(t).and.(.false.)
        write(LIS_logunit,*) 'problem updating sm3 ', soilm3(t),NOAHMP401_struc(n)%noahmp401(t)%smc(3),NOAHMP401_struc(n)%noahmp401(t)%sh2o(3),MIN_THRESHOLD,sm_threshold
     endif
     if(NOAHMP401_struc(n)%noahmp401(t)%smc(4)+delta4.ge.MIN_THRESHOLD .and. &
        ...
        update_flag(gid) = update_flag(gid).and.(.false.)
        update_flag_tile(t) = update_flag_tile(t).and.(.false.)
        write(LIS_logunit,*) 'problem updating sm4 ', soilm4(t),NOAHMP401_struc(n)%noahmp401(t)%smc(4),NOAHMP401_struc(n)%noahmp401(t)%sh2o(4),MIN_THRESHOLD,sm_threshold
     endif
