...
!BOP
! !ROUTINE: noahmp401_descale_usafsi
! \label{noahmp401_descale_usafsi}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_descale_usafsi(n, LSM_State, LSM_Incr_State)
...
end subroutine noahmp401_descale_usafsi
