...
!BOP
! !ROUTINE: noahmp401_qc_burnareaobs
! \label{noahmp401_qc_burnareaobs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_qc_burnareaobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noahmp401_qc_burnareaobs
