...
!BOP
!
! !ROUTINE: jules51_coldstart
! \label{jules51_coldstart}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules51_coldstart(mtype)
   ! !USES:
...
!EOP
   ...
   do n=1, LIS_rc%nnest
      if (trim(LIS_rc%startcode) .eq. "coldstart") then
         write(LIS_logunit,*) "MSG: jules51_coldstart -- cold-starting jules51"
         k = 1
         do
