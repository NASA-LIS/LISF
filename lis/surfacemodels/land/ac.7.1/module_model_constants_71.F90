...
!
 ...
 MODULE module_model_constants_71
...
! JM NOTE -- can we name this grav instead?
   ...
   REAL    , PARAMETER :: reradius     = 1./6371.0e03 
...
!
   ...
   REAL    , PARAMETER ::  STBOLT=5.67151E-8
...
!       REAL , PARAMETER ::  defm=32.0
       ...
       REAL , PARAMETER ::  tlc=2.*0.713972477
...
! for calls to set_tiles
 ...
 END MODULE module_model_constants_71
