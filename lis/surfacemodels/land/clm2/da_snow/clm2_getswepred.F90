...
!BOP
! !ROUTINE: clm2_getswepred
! \label{clm2_getswepred}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine clm2_getswepred(n, obs_pred)
! !USES:
  use ESMF
...
!EOP
  ...
  do i=1,LIS_rc%npatch(n,LIS_rc%lsm_index),LIS_rc%nensem(n)
     do m=1,LIS_rc%nensem(n)
        ...
        obs_pred(gid,m)= clm2_struc(n)%clm(t)%h2osno
     enddo
  enddo
end subroutine clm2_getswepred
