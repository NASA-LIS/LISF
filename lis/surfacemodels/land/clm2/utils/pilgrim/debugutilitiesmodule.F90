...
!        DumAssert         & Make an assertion \cr \hline
!        DumEnter          & Tracing: enter a subroutine \cr \hline
!        DumLeave          & Tracing: leave a subroutine   \cr \hline
!      \end{tabular}
!
...
!        {\bf Debug Level} & {\bf Action} \cr \hline \hline
!        0                 & Return immediately \cr \hline
!        1                 & Print assertion failed \cr \hline
!        2                 & Print assertion failed and trace stack \cr \hline
!      \end{tabular}
!
! !LOCAL VARIABLES:
...
!        {\bf Debug Level} & {\bf Action} \cr \hline \hline
!        0                 & Return immediately \cr \hline
!        1                 & Perform bookkeeping \cr \hline
!        2                 & Perform bookkeeping, print trace \cr \hline
!      \end{tabular}
!
! !LOCAL VARIABLES:
      INTEGER MyID, Ierror
...
!        {\bf Debug Level} & {\bf Action} \cr \hline \hline
!        0                 & Return immediately \cr \hline
!        1                 & Perform bookkeeping, consistency check \cr \hline
!        2                 & Bookkeeping, consistency, print trace \cr \hline
!      \end{tabular}
!
! !LOCAL VARIABLES:
      INTEGER MyID, Ierror
