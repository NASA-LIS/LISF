...
!BOP
!
! !ROUTINE: jules54_main
! \label{jules54_main}
!
! !ROUTINE: jules54_main.F90
!
! !REVISION HISTORY:
...
! !DESCRIPTION:
!
!  Calls the run routines for the forcing-only option (jules54)
!
!  The arguments are:
!  \begin{description}
!  \item[n]
...
!EOP
   ...
   alarmCheck = LIS_isAlarmRinging(LIS_rc, "JULES.5.4 model alarm")
   if (alarmCheck) Then
      do m = 1, LIS_rc%nensem(n)
         ...
         do
            ...
            start_k = k
            end_k = jules54_struc(n)%jules54(start_k)%end_k 
            k = end_k + 1 
            ...
            do t=start_k, end_k
               if ( LIS_surface(n,LIS_rc%lsm_index)%tile(t)%ensem == m ) then
                 pft = jules54_struc(n)%jules54(t)%pft 
                 jules54_struc(n)%jules54(t)%frac(pft) = LIS_surface(n,LIS_rc%lsm_index)%tile(t)%fgrd
                 tstar_box=tstar_box+jules54_struc(n)%jules54(t)%frac(pft)*jules54_struc(n)%jules54(t)%tstar_tile(pft)
               endif
            enddo
            ...
            do t=start_k, end_k
               if ( LIS_surface(n,LIS_rc%lsm_index)%tile(t)%ensem == m ) then
                  pft = jules54_struc(n)%jules54(t)%pft 
                  jules54_struc(n)%jules54(t)%frac(pft) = LIS_surface(n,LIS_rc%lsm_index)%tile(t)%fgrd
                  jules54_struc(n)%jules54(t)%land_mask = .true.
                  jules54_struc(n)%jules54(t)%z1_tq = jules54_struc(n)%z1_tq
                  jules54_struc(n)%jules54(t)%z1_uv = jules54_struc(n)%z1_uv

                  jules54_struc(n)%jules54(t)%tstar=tstar_box
            ...
            do t=start_k, end_k
               if ( LIS_surface(n,LIS_rc%lsm_index)%tile(t)%ensem == m ) then
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,         &
                        LIS_MOC_SOILTEMP,                            &
                        value=jules54_struc(n)%jules54(t)%t_soil(i), &
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,       &
                        LIS_MOC_SOILMOIST,                         &
                        value=jules54_struc(n)%jules54(t)%smcl_soilt(i), &
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     ...
                     smc_liq = jules54_struc(n)%jules54(t)%p_s_sthu(i) * jules54_struc(n)%jules54(t)%p_s_smvcst(i) 
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                        LIS_MOC_SMLIQFRAC,                             &
                        value=smc_liq,                                 &
                        vlevel=i, unit="m^3 m-3", direction="-",       &
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     ...
                     smc_sat_frac = jules54_struc(n)%jules54(t)%p_s_sthu(i)+jules54_struc(n)%jules54(t)%p_s_sthf(i)
                     if (smc_sat_frac > tiny(smc_sat_frac)) then 
                        smc_liq = jules54_struc(n)%jules54(t)%p_s_sthu(i) / smc_sat_frac
                     else
                        smc_liq = 0.0
                     endif 
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     smc_ice = jules54_struc(n)%jules54(t)%p_s_sthf(i) * jules54_struc(n)%jules54(t)%p_s_smvcst(i) 
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                        LIS_MOC_SMFROZFRAC,                            &
                        value=smc_ice,                                 &
                        vlevel=i, unit="m^3 m-3", direction="-",       &
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     ...
                     smc_sat_frac = jules54_struc(n)%jules54(t)%p_s_sthu(i)+jules54_struc(n)%jules54(t)%p_s_sthf(i)
                     if (smc_sat_frac > tiny(smc_sat_frac)) then
                        smc_ice = jules54_struc(n)%jules54(t)%p_s_sthf(i) / smc_sat_frac
                     else
                        smc_ice = 0.0
                     endif
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                        LIS_MOC_JULES_STHU,                            &
                        value=jules54_struc(n)%jules54(t)%p_s_sthu(i), &
                        vlevel=i, unit="-", direction="-",             &
                        valid_min=0.0, valid_max=1.0,                  &
                        surface_type=LIS_rc%lsm_index)
                  enddo
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                        LIS_MOC_JULES_STHF,                            &
                        value=jules54_struc(n)%jules54(t)%p_s_sthf(i), &
                        vlevel=i, unit="-", direction="-",             &
                        valid_min=0.0, valid_max=1.0,                  &
                        surface_type=LIS_rc%lsm_index)
                  enddo
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,               &
                     ...
                     value=jules54_struc(n)%jules54(t)%p_s_sthu_min(1), &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,             &
                     ...
                     value=jules54_struc(n)%jules54(t)%p_s_smvccl(1), &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,             &
                     ...
                     value=jules54_struc(n)%jules54(t)%p_s_smvcst(1), &
                     vlevel=1, unit="m^3 m-3", direction="-",         &
                     valid_min=0.0, valid_max=1.0,                    &
                        surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,             &
                     ...
                     value=jules54_struc(n)%jules54(t)%p_s_smvcwt(1), &
                     vlevel=1, unit="m^3 m-3", direction="-",         &
                     valid_min=0.0, valid_max=1.0,                    &
                        surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_EVAP,                              &
                     value=jules54_struc(n)%jules54(t)%fqw_1,   &
                     vlevel=1,unit="kg m-2 s-1",direction="UP", &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,     &
                     LIS_MOC_QH,                              &
                     value=jules54_struc(n)%jules54(t)%ftl_1, &
                     vlevel=1,unit="W m-2",direction="UP",    &
                     surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,         &
                     LIS_MOC_ECANOP,                             &
                     value=jules54_struc(n)%jules54(t)%ecan,     &
                     vlevel=1,unit="kg m-2 s-1", direction="UP", &
                     surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n,t,         &
                     LIS_MOC_JULES_ESOIL,                             &
                     value=jules54_struc(n)%jules54(t)%esoil,     &
                     vlevel=1,unit="kg m-2 s-1", direction="UP", &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,       &
                     LIS_MOC_SUBSNOW,                          &
                     value=jules54_struc(n)%jules54(t)%ei,     &
                  ...
                  do i=1, jules54_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n,t,             &
                        LIS_MOC_SOILET,                                 &
                        vlevel=i,                                       &
                        value=jules54_struc(n)%jules54(t)%ext(i),       &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,               &
                     LIS_MOC_SNOWDEPTH,                                &
                     vlevel=1,                                         &
                     value=jules54_struc(n)%jules54(t)%snowdepth(pft), &
                     unit="m", direction="-",&
                     surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                &
                      LIS_MOC_SWE,                                       &
                      value =  jules54_struc(n)%jules54(t)%snow_mass_ij, &
                      vlevel=1, unit="kg m-2", direction="-",            &
                      surface_type = LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,              &
                      LIS_MOC_WATERTABLED,                             &
                      value = JULES54_struc(n)%jules54(t)%zw,          &
                      vlevel=1, unit="m", direction="-",               &
                      surface_type = LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,                &
                     LIS_MOC_AVGSURFT,                                  &
                     value=jules54_struc(n)%jules54(t)%tstar_tile(pft), &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,               &
                     LIS_MOC_EMISSFORC,                                 &
                     value = jules54_struc(n)%jules54(t)%emis_tile(pft),&
                     vlevel=1, unit="-", direction="-",                 &
                     surface_type = LIS_rc%lsm_index)

                  !***  surface radiative temperature 
                  trad_gb_mean = 0.0
                  do p=1, jules54_struc(n)%jules54(t)%nsurft
                    trad_gb_mean = trad_gb_mean + frac(1,p) * jules54_struc(n)%jules54(t)%tstar_tile(p)**4.0
                  enddo
                  ...
                  lw_upward = sbcon * jules54_struc(n)%jules54(t)%emis_tile(pft) * jules54_struc(n)%jules54(t)%tstar_tile(pft)**4 
                  lw_net    = jules54_struc(n)%jules54(t)%emis_tile(pft) * jules54_struc(n)%jules54(t)%lwdown - lw_upward 
                  call LIS_diagnoseSurfaceOutputVar(n, t,                          &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,                 &
                     LIS_MOC_ROUGHNESS,                                  &
                     value=jules54_struc(n)%jules54(t)%p_s_z0_tile(pft), &
                     vlevel=1,unit="m",direction="-",                    &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,                       &
                     LIS_MOC_THERMAL_ROUGHNESS,                                &
                     value=jules54_struc(n)%jules54(t)%p_s_z0_tile(pft) * z0h_z0m(pft), &
                     vlevel=1,unit="m",direction="-",                          &
                     surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_QSB,                                             &
                     value = jules54_struc(n)%jules54(t)%sub_surf_roff,       &
                     vlevel=1, unit="kg m-2 s-1", direction="OUT", surface_type = LIS_rc%lsm_index)
                  
                  ! EMK
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_QS,                              &
                     value=jules54_struc(n)%jules54(t)%surf_roff*dt,   &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_QSB,                              &
                     value=jules54_struc(n)%jules54(t)%sub_surf_roff*dt,   &
                     vlevel=1,unit="kg m-2",direction="OUT", &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_QS,                                              &
                     value = jules54_struc(n)%jules54(t)%surf_roff,           &
                     vlevel=1, unit="kg m-2 s-1", direction="OUT", surface_type = LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_QSM,                                             &
                     value = jules54_struc(n)%jules54(t)%snow_melt_gb,        &
                     vlevel=1, unit="kg m-2 s-1", direction="S2L", surface_type = LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_DRIP,                                            &
                     value = jules54_struc(n)%jules54(t)%tot_tfall,           &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_CANOPINT,                                        &
                     value = jules54_struc(n)%jules54(t)%canopy(pft),      &
                     vlevel=1, unit="kg m-2", direction="-", &
                     surface_type = LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_SWNET,                                           &
                     value= jules54_struc(n)%jules54(t)%sw_tile(pft),         &  
                     vlevel=1,  unit="W m-2", direction="DN", surface_type=LIS_rc%lsm_index)

                  if(pft <= jules54_struc(n)%npft) then  
                    ! vegetation surface types 
                    call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                       LIS_MOC_LAI,                                             &
                       value= jules54_struc(n)%jules54(t)%lai(pft),             &  
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_JULES_FSAT,                                             &
                     value= jules54_struc(n)%jules54(t)%fsat,             &  
                     vlevel=1,  unit="-", direction="-", surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_JULES_FWETL,                                             &
                     value= jules54_struc(n)%jules54(t)%fwetl,             &  
                     vlevel=1,  unit="-", direction="-", surface_type=LIS_rc%lsm_index)
...
! EMK BEGIN New output variables
                  ...
                  sfcprs = jules54_struc(n)%jules54(t)%psurf
                  sfctmp = jules54_struc(n)%jules54(t)%tair
                  q2 = jules54_struc(n)%jules54(t)%qair
                  es = 611.0*exp(2.501E6/461.0*(1./273.15 - 1./sfctmp))
                  q2sat = 0.622*es/(sfcprs-(1.-0.622)*es)
                  if (sfctmp .lt. &
                       jules54_struc(n)%jules54(t)%tair_agl_min) then
                     jules54_struc(n)%jules54(t)%tair_agl_min = sfctmp
                     jules54_struc(n)%jules54(t)%rhmin = q2 / q2sat
                  end if

                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_RHMIN,                              &
                     value=jules54_struc(n)%jules54(t)%rhmin,   &
                     vlevel=1,unit="-",direction="-", &
                     surface_type=LIS_rc%lsm_index)
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_RHMIN,                              &
                     value=(jules54_struc(n)%jules54(t)%rhmin*100),   &
                     vlevel=1,unit="%",direction="-", &
                     surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_SNOW_SOOT,                          &
                     value=jules54_struc(n)%jules54(t)%soot_ij,   &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                &
                      LIS_MOC_GRND_SNOW,                                       &
                      value =  jules54_struc(n)%jules54(t)%snow_grnd(pft), &
                      vlevel=1, unit="kg m-2", direction="-",            &
                      surface_type = LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                &
                      LIS_MOC_SURFT_SNOW,                                       &
                      value =  jules54_struc(n)%jules54(t)%snow_tile(pft), &
                      vlevel=1, unit="kg m-2", direction="-",            &
                      surface_type = LIS_rc%lsm_index)
                  
                  ! bulk snow density 
                  call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_SNOWDENSITY, &
                      value =  jules54_struc(n)%jules54(t)%rho_snow_grnd(pft),&
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_SNOWGRAIN, &
                      value =  jules54_struc(n)%jules54(t)%rgrain(pft),&
                  ...
                  if(nsmax .eq.0) then
                    ...
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                       LIS_MOC_SNOWICEBULK,                         &
                       value=jules54_struc(n)%jules54(t)%sice(1,1), &
                       vlevel=1, unit="kg m-2", direction="-",    &
                       surface_type=LIS_rc%lsm_index)
                    ! snow liquid water 
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                       LIS_MOC_SNOWLIQBULK,                         &
                       value=jules54_struc(n)%jules54(t)%sliq(1,1), &
                       vlevel=1, unit="kg m-2", direction="-",    &
                       surface_type=LIS_rc%lsm_index)
                    ! snow temperature
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                       LIS_MOC_SNOWT,                         &
                       value=jules54_struc(n)%jules54(t)%tsnow(1,1), &
                       vlevel=1, unit="K", direction="-",    &
                       surface_type=LIS_rc%lsm_index)
                  !!! nsmax > 0, multi-layer snow physics
                    ...
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                       LIS_MOC_SOWN_NLAYER,                         &
                       value=jules54_struc(n)%jules54(t)%nsnow(pft)*1.0, & ! nsnow is integer, -> real by *1.0
                       vlevel=1, unit="-", direction="-",    &
                       surface_type=LIS_rc%lsm_index)

                    do i=1, jules54_struc(n)%nsmax
                      ! layer snow ice 
                       call LIS_diagnoseSurfaceOutputVar(n, t,       &
                          LIS_MOC_SNOWICEPROF,                         &
                          value=jules54_struc(n)%jules54(t)%sice(pft,i), &
                          vlevel=i, unit="kg m-2", direction="-",    &
                          surface_type=LIS_rc%lsm_index)
                      ! layer snow liquid water 
                       call LIS_diagnoseSurfaceOutputVar(n, t,       &
                          LIS_MOC_SNOWLIQPROF,                         &
                          value=jules54_struc(n)%jules54(t)%sliq(pft,i), &
                          vlevel=i, unit="kg m-2", direction="-",    &
                          surface_type=LIS_rc%lsm_index)
                      ! layer snow temperature K 
                       call LIS_diagnoseSurfaceOutputVar(n, t,            &
                          LIS_MOC_SNOWTPROF,                              &
                          value=jules54_struc(n)%jules54(t)%tsnow(pft,i), &
                          vlevel=i, unit="K", direction="-",              &
                          surface_type=LIS_rc%lsm_index)
                      ! layer snow density 
                      call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_SNOWDENPROF, &
                        value = jules54_struc(n)%jules54(t)%rho_snow(pft,i),&
                      ...
                      call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_SNOWGRNPROF, &
                        value =  jules54_struc(n)%jules54(t)%rgrainl(pft,i),&
                      ...
                      call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_SNOWDEPPROF, &
                        value = jules54_struc(n)%jules54(t)%ds(pft,i),& 
                  ...
                  snow_frac = 0.0
                  if(l_aggregate) then
                    if(jules54_struc(n)%jules54(t)%snow_tile(1)+jules54_struc(n)%jules54(t)%snow_grnd(1)>1.0) then
                      snow_frac = 1.0
                    endif
                  else
                    if(jules54_struc(n)%jules54(t)%snow_tile(pft)+jules54_struc(n)%jules54(t)%snow_grnd(pft)>1.0) then
                      snow_frac = jules54_struc(n)%jules54(t)%frac(pft)
                    endif
                  endif
                  ...
                  prcp = jules54_struc(n)%jules54(t)%rainf/jules54_struc(n)%forc_count
                  
                  if (jules54_struc(n)%jules54(t)%tair  .lt. 273.16) then 
                  ...
                  cpcp   = jules54_struc(n)%jules54(t)%rainf_c/jules54_struc(n)%forc_count
                  ...
                  albedo_land = wght_alb(1) * jules54_struc(n)%jules54(t)%land_albedo(1) &
                              + wght_alb(2) * jules54_struc(n)%jules54(t)%land_albedo(2) &
                              + wght_alb(3) * jules54_struc(n)%jules54(t)%land_albedo(3) &
                              + wght_alb(4) * jules54_struc(n)%jules54(t)%land_albedo(4) 
...
!                 ! JULES GPP and NPP
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_GPP, value = 1000.0 * jules54_struc(n)%jules54(t)%gpp, &
                  ...
                  ! (g m-2 s-1) = 1000.0 * (kg m-2 s-1)
                  call LIS_diagnoseSurfaceOutputVar(n, t, LIS_MOC_NPP, value = 1000.0 * jules54_struc(n)%jules54(t)%npp, &
                                              vlevel=1, unit="g m-2 s-1", direction="IN", surface_type = LIS_rc%lsm_index)
!                ! End JULES GPP and NPP 

!                   !EMK Below code is borrowed from Noah 3.6
                  do i=1, jules54_struc(n)%sm_levels
                     smc = jules54_struc(n)%jules54(t)%smcl_soilt(i)/ &
                          (1000.0*dzsoil(i))
                     smcwilt = jules54_struc(n)%jules54(t)%sm_wilt
                     smcmax = jules54_struc(n)%jules54(t)%sm_sat
...
! EMK END New output variables
                  ...
                  jules54_struc(n)%jules54(t)%rainf_c = 0.0
   ...
   ! EMK...See if jules54_struc(n)%jules54(t)%tair_agl_min needs to be reset
   ! for calculating RHMin.  
   write(fnest,'(i3.3)') n
   alarmCheck = LIS_isAlarmRinging(LIS_rc, &
        "JULES.5.4 RHMin alarm "//trim(fnest))
   if (alarmCheck) then
      write(LIS_logunit,*)'[INFO] Resetting tair_agl_min for RHMin calculation'
     do t = 1,LIS_rc%npatch(n,LIS_rc%lsm_index)
        jules54_struc(n)%jules54(t)%tair_agl_min = 999.
     end do
  end if

end subroutine jules54_main
