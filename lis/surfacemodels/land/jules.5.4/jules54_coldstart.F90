...
!BOP
!
! !ROUTINE: jules54_coldstart
! \label{jules54_coldstart}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules54_coldstart(mtype)
   ! !USES:
...
!EOP
   ...
   do n=1, LIS_rc%nnest
      if (trim(LIS_rc%startcode) .eq. "coldstart") then
         write(LIS_logunit,*) "MSG: jules54_coldstart -- cold-starting jules54"
         k = 1
         do
