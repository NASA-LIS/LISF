...
!BOP
! !ROUTINE: mos_getsynsmpred
! \label{mos_getsynsmpred}
!
! !REVISION HISTORY:
! 06 Oct 2007: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine mos_getsynsmpred(n, obs_pred)
! !USES:
  use ESMF
...
!EOP
  ...
  do i=1,LIS_rc%npatch(n,LIS_rc%lsm_index),LIS_rc%nensem(n)
     do m=1,LIS_rc%nensem(n)
        ...
        obs_pred(gid,m)= obs_pred(gid,m) + mos_struc(n)%mos(t)%water1/20.0
...
end subroutine mos_getsynsmpred
