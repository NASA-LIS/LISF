...
!BOP
! !ROUTINE: mos_descale_soilm
! \label{mos_descale_soilm}
!
! !REVISION HISTORY:
! 27Feb2005: Sujay Kumar; Initial Specification
! 24Mar2005: Xiwu Zhan; modified for Mos model
! 25Jun2006: Sujay Kumar: Updated for the ESMF design
!
! !INTERFACE:
subroutine mos_descale_soilm(n, LSM_State, LSM_Incr_State)
...
end subroutine mos_descale_soilm
