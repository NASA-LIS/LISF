...
!BOP
! !ROUTINE: clsmf25_descale_soilm
! \label{clsmf25_descale_soilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine clsmf25_descale_soilm(n, LSM_State, LSM_Incr_State)
...
end subroutine clsmf25_descale_soilm
