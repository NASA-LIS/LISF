...
!BOP
! !ROUTINE: clsmf25_write_soilm
! \label{clsmf25_write_soilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine clsmf25_write_soilm(ftn,n, LSM_State)
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     tmp(t) = clsmf25_struc(n)%cat_progn(t)%rzexc
  enddo
  call LIS_writevar_restart(ftn,n,1,tmp)
...
end subroutine clsmf25_write_soilm
