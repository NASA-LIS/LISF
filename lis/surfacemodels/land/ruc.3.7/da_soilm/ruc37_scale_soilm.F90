...
!BOP
! !ROUTINE: RUC37_scale_soilm
! \label{RUC37_scale_soilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine RUC37_scale_soilm(n, LSM_State)
...
!  call ESMF_StateGet(LSM_State,"Soil Moisture Level 1",sm1Arr,rc=status)
!  call LIS_verify(status)
!  call ESMF_StateGet(LSM_State,"Soil Moisture Level 2",sm2Arr,rc=status)
!  call LIS_verify(status)
!  call ESMF_StateGet(LSM_State,"Soil Moisture Level 3",sm3Arr,rc=status)
!  call LIS_verify(status)
!  call ESMF_StateGet(LSM_State,"Soil Moisture Level 4",sm4Arr,rc=status)
!  call LIS_verify(status)
...
end subroutine RUC37_scale_soilm
