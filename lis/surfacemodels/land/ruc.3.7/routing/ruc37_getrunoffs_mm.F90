...
!BOP
! !ROUTINE: ruc37_getrunoffs_mm
!  \label{ruc37_getrunoffs_mm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ruc37_getrunoffs_mm(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  ! units - mm s-1
     runoff1(t) = RUC37_struc(n)%ruc37(t)%qs
     runoff2(t) = RUC37_struc(n)%ruc37(t)%qsb
...
end subroutine ruc37_getrunoffs_mm
