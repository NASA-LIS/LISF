...
int initialize_model_state(dist_prcp_struct    *prcp,
                           ...
                           int                **init_DRY_TIME,
                           float               *states) // added by Shugong Wang
/**********************************************************************
  ...
  2014-May-16 Add float *states to argument for modified read_initial_model_state. Shugong Wang
**********************************************************************/
{
    ...
    ************************************************************************/
    ...
    if(options.INIT_STATE) {
        ...
        /*    read_initial_model_state(filep.init_state, prcp, global_param,
                         ...
                         states); // added yb Shugong Wang 05/16/2014
        */
        /* unpack 1D state vector array into corresponding variables */
        unpack_model_state(prcp, global_param,
                           Nveg, options.SNOW_BAND, cellnum, soil_con,
                           Ndist, *init_STILL_STORM, *init_DRY_TIME, lake_con,
                           states);
#if EXCESS_ICE
