...
*************************************************************/
  ...
  strcpy(out_data[OUT_LAKE_BF_IN].varname,"OUT_LAKE_BF_IN");           /* incoming baseflow from lake catchment [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_BF_IN_V].varname,"OUT_LAKE_BF_IN_V");       /* incoming volumetric baseflow from lake catchment [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_BF_OUT].varname,"OUT_LAKE_BF_OUT");         /* outgoing baseflow lake [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_BF_OUT_V].varname,"OUT_LAKE_BF_OUT_V");     /* outgoing volumetric baseflow from lake [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_CHAN_IN].varname,"OUT_LAKE_CHAN_IN");       /* channel inflow into lake [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_CHAN_IN_V].varname,"OUT_LAKE_CHAN_IN_V");   /* volumetric channel inflow into lake [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_CHAN_OUT].varname,"OUT_LAKE_CHAN_OUT");     /* channel outflow from lake [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_CHAN_OUT_V].varname,"OUT_LAKE_CHAN_OUT_V"); /* volumetric channel outflow from lake [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_DSTOR].varname,"OUT_LAKE_DSTOR");           /* change in lake moisture storage (liquid plus ice cover) [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_DSTOR_V].varname,"OUT_LAKE_DSTOR_V");       /* volumetric change in lake moisture storage (liquid plus ice cover) [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_DSWE].varname,"OUT_LAKE_DSWE");             /* change in snowpack on top of lake ice [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_DSWE_V].varname,"OUT_LAKE_DSWE_V");         /* volumetric change in snowpack on top of lake ice [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_EVAP].varname,"OUT_LAKE_EVAP");             /* net evaporation from lake surface [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_EVAP_V].varname,"OUT_LAKE_EVAP_V");         /* net volumetric evaporation from lake surface [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_PREC_V].varname,"OUT_LAKE_PREC_V");         /* volumetric precipitation over lake surface [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_RCHRG].varname,"OUT_LAKE_RCHRG");           /* recharge from lake to surrounding wetland [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_RCHRG_V].varname,"OUT_LAKE_RCHRG_V");       /* volumetric recharge from lake to surrounding wetland [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_RO_IN].varname,"OUT_LAKE_RO_IN");           /* incoming runoff from lake catchment [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_RO_IN_V].varname,"OUT_LAKE_RO_IN_V");       /* incoming volumetric runoff from lake catchment [m3] (ALMA_OUTPUT: [m3 s-1]) */
  strcpy(out_data[OUT_LAKE_VAPFLX].varname,"OUT_LAKE_VAPFLX");         /* sublimation from lake snow pack [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_LAKE_VAPFLX_V].varname,"OUT_LAKE_VAPFLX_V");     /* volumetric sublimation from lake snow pack [m3] (ALMA_OUTPUT: [m3 s-1]) */
  ...
  strcpy(out_data[OUT_RUNOFF].varname,"OUT_RUNOFF");                   /* surface runoff [mm] (ALMA_OUTPUT: [mm s-1]) */
  ...
  strcpy(out_data[OUT_TRANSP_VEG].varname,"OUT_TRANSP_VEG");           /* net transpiration from vegetation [mm] (ALMA_OUTPUT: [mm s-1]) */
