/*
 * SUMMARY:      vic411_CalcAerodynamic.c - Calculate the aerodynamic resistances
 * USAGE:        Part of DHSVM
 *
 ...
 * DESCRIP-END.
 * FUNCTIONS:    vic411_CalcAerodynamic()
...
static char vcid[] = "$Id: vic411_CalcAerodynamic.c,v 5.1.2.2 2009/06/09 09:54:10 vicadmin Exp $";

  
/*****************************************************************************
  Function name: vic411_CalcAerodynamic()
  ...
  Purpose      : Calculate the aerodynamic resistance for each vegetation 
                 ...
                 speed, Uref, of 1 m s-1.  To get wind speeds and aerodynamic 
  ...
  Required     :
    ...
    char OverStory - vic411_flag for presence of overstory.  Only used if NVegLayers 
                     is equal to 1
  ...
  Comments     :
*****************************************************************************/
int  vic411_CalcAerodynamic(char    OverStory,     /* overstory vic411_flag */
                     ...
                     double *roughness)     /* vegetation roughness */
{
  /******************************************************************
  Modifications:
  2007-Apr-04 Modified to catch and return error flags from vic411_surface_fluxes
              subroutine.                                      GCT/KAC
  ...
  *******************************************************************/
  ...
  /* Overstory present, one or two vegetation layers possible */
    ...
    if (Zt < (Z0_Lower+d_Lower)) {
      fprintf(stderr,"ERROR: vic411_CalcAerodynamic - Trunk space height below \"center\" of lower boundary");
      return( ERROR );
    }
