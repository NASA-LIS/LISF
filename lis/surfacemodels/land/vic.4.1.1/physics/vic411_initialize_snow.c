...
static char vcid[] = "$Id: vic411_initialize_snow.c,v 5.4.2.2 2009/09/28 21:46:58 vicadmin Exp $";

void vic411_initialize_snow (vic411_snow_data_struct **snow, 
		      int                veg_num,
		      int                cellnum)
/**********************************************************************
	vic411_initialize_snow		Keith Cherkauer		January 22, 1997
...
**********************************************************************/
{
  ...
  if(vic411_options.FROZEN_SOIL) startlayer=2;
  else startlayer=0;
