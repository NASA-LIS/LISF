...
static char vcid[] = "$Id: vic411_read_snowband.c,v 5.3.2.4 2009/09/28 21:46:58 vicadmin Exp $";

void vic411_read_snowband(FILE    *snowband,
		   vic411_soil_con_struct *soil_con)
/**********************************************************************
  vic411_read_snowband		Keith Cherkauer		July 9, 1998
  ...
  2009-Sep-28 Moved initialization of snow band parameters to the
	      vic411_read_soilparam* functions.				TJB
**********************************************************************/
{
