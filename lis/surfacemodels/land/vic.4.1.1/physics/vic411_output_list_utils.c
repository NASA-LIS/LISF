...
/*************************************************************
  vic411_create_output_list()      Ted Bohn     September 08, 2006
...
*************************************************************/
  ...
  out_data = (vic411_out_data_struct *)calloc(N_OUTVAR_TYPES,sizeof(vic411_out_data_struct));
  ...
  strcpy(out_data[OUT_BASEFLOW].varname,"OUT_BASEFLOW");               /* baseflow out of the bottom layer [mm] (ALMA_OUTPUT: [mm s-1]) */
  ...
  strcpy(out_data[OUT_EVAP].varname,"OUT_EVAP");                       /* total net evaporation [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_EVAP_BARE].varname,"OUT_EVAP_BARE");             /* net evaporation from bare soil [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_EVAP_CANOP].varname,"OUT_EVAP_CANOP");           /* net evaporation from canopy interception [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_EVAP_LAKE].varname,"OUT_EVAP_LAKE");             /* net evaporation from lake surface [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_INFLOW].varname,"OUT_INFLOW");                   /* moisture that reaches top of soil column [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PET_SATSOIL].varname,"OUT_PET_SATSOIL");         /* potential evap from saturated bare soil [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PET_H2OSURF].varname,"OUT_PET_H2OSURF");         /* potential evap from open water [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PET_SHORT].varname,"OUT_PET_SHORT");             /* potential evap from short reference crop (grass) [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PET_TALL].varname,"OUT_PET_TALL");               /* potential evap from tall reference crop (alfalfa) [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PET_NATVEG].varname,"OUT_PET_NATVEG");           /* potential evap from current vegetation and current canopy resistance [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PET_VEGNOCR].varname,"OUT_PET_VEGNOCR");         /* potential evap from current vegetation and 0 canopy resistance bare soil [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_PREC].varname,"OUT_PREC");                       /* incoming precipitation [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_RAINF].varname,"OUT_RAINF");                     /* rainfall [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_REFREEZE].varname,"OUT_REFREEZE");               /* refreezing of water in the snow [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_RUNOFF].varname,"OUT_RUNOFF");                   /* surface vic411_runoff [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_SNOW_MELT].varname,"OUT_SNOW_MELT");             /* snow melt [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_SNOWF].varname,"OUT_SNOWF");                     /* snowfall [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_SUB_BLOWING].varname,"OUT_SUB_BLOWING");         /* net sublimation of blowing snow [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_SUB_CANOP].varname,"OUT_SUB_CANOP");             /* net sublimation from snow stored in canopy [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_SUB_SNOW].varname,"OUT_SUB_SNOW");               /* net sublimation from snow pack (surface and blowing) [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_SUB_SURFACE].varname,"OUT_SUB_SURFACE");         /* net sublimation from snow pack surface [mm] (ALMA_OUTPUT: [mm s-1]) */
  strcpy(out_data[OUT_TRANSP_VEG].varname,"OUT_TRANSP_VEG");           /* net vic411_transpiration from vegetation [mm] (ALMA_OUTPUT: [mm s-1]) */
  ...
  strcpy(out_data[OUT_SNOWT_FBFLAG].varname,"OUT_SNOWT_FBFLAG");       /* snow surface temperature vic411_flag */
  ...
  strcpy(out_data[OUT_SOILT_FBFLAG].varname,"OUT_SOILT_FBFLAG");       /* soil temperature vic411_flag for each soil thermal node */
  strcpy(out_data[OUT_SURF_TEMP].varname,"OUT_SURF_TEMP");             /* average surface temperature [C] (ALMA_OUTPUT: [K]) */
  strcpy(out_data[OUT_SURFT_FBFLAG].varname,"OUT_SURFT_FBFLAG");       /* surface temperature vic411_flag */
  strcpy(out_data[OUT_TCAN_FBFLAG].varname,"OUT_TCAN_FBFLAG");         /* Tcanopy vic411_flag */
  strcpy(out_data[OUT_TDEPTH].varname,"OUT_TDEPTH");                   /* depth of thawing fronts [cm] (ALMA_OUTPUT: [m]) for each thawing front */
  strcpy(out_data[OUT_TFOL_FBFLAG].varname,"OUT_TFOL_FBFLAG");         /* Tfoliage vic411_flag */
  ...
  strcpy(out_data[OUT_ADV_SENS].varname,"OUT_ADV_SENS");               /* net sensible heat advected to snow pack [W m-2] */
  strcpy(out_data[OUT_ADVECTION].varname,"OUT_ADVECTION");             /* advected energy [W m-2] */
  strcpy(out_data[OUT_DELTACC].varname,"OUT_DELTACC");                 /* rate of change in cold content in snow pack [W m-2] */
  strcpy(out_data[OUT_DELTAH].varname,"OUT_DELTAH");                   /* rate of change in heat storage [W m-2] */
  strcpy(out_data[OUT_ENERGY_ERROR].varname,"OUT_ENERGY_ERROR");       /* energy budget error [W m-2] */
  strcpy(out_data[OUT_WATER_ERROR].varname,"OUT_WATER_ERROR");         /* water budget error [mm] */
  strcpy(out_data[OUT_FUSION].varname,"OUT_FUSION");                   /* net energy used to melt/freeze soil moisture [W m-2] */
  strcpy(out_data[OUT_GRND_FLUX].varname,"OUT_GRND_FLUX");             /* net heat flux into ground [W m-2] */
  strcpy(out_data[OUT_IN_LONG].varname,"OUT_IN_LONG");                 /* incoming longwave flux at surface (under veg) [W m-2] */
  strcpy(out_data[OUT_LATENT].varname,"OUT_LATENT");                   /* net upward latent heat flux [W m-2] */
  strcpy(out_data[OUT_LATENT_SUB].varname,"OUT_LATENT_SUB");           /* net upward latent heat flux from sublimation [W m-2] */
  strcpy(out_data[OUT_MELT_ENERGY].varname,"OUT_MELT_ENERGY");         /* energy of fusion (melting) [W m-2] */
  strcpy(out_data[OUT_NET_LONG].varname,"OUT_NET_LONG");               /* net downward longwave flux [W m-2] */
  strcpy(out_data[OUT_NET_SHORT].varname,"OUT_NET_SHORT");             /* net downward shortwave flux [W m-2] */
  strcpy(out_data[OUT_R_NET].varname,"OUT_R_NET");                     /* net downward radiation flux [W m-2] */
  strcpy(out_data[OUT_RFRZ_ENERGY].varname,"OUT_RFRZ_ENERGY");         /* net energy used to refreeze liquid water in snowpack [W m-2] */
  strcpy(out_data[OUT_SENSIBLE].varname,"OUT_SENSIBLE");               /* net upward sensible heat flux [W m-2] */
  strcpy(out_data[OUT_SNOW_FLUX].varname,"OUT_SNOW_FLUX");             /* energy flux through snow pack [W m-2] */

  // Miscellaneous Terms
  strcpy(out_data[OUT_AERO_COND].varname,"OUT_AERO_COND");             /* "scene" aerodynamic conductance [m s-1] (tiles with overstory contribute overstory conductance; others contribue surface conductance) */
  strcpy(out_data[OUT_AERO_COND1].varname,"OUT_AERO_COND1");           /* surface aerodynamic conductance [m s-1] */
  strcpy(out_data[OUT_AERO_COND2].varname,"OUT_AERO_COND2");           /* overstory aerodynamic conductance [m s-1] */
  ...
  strcpy(out_data[OUT_AERO_RESIST1].varname,"OUT_AERO_RESIST1");       /* surface aerodynamic resistance [m s-1] */
  strcpy(out_data[OUT_AERO_RESIST2].varname,"OUT_AERO_RESIST2");       /* overstory aerodynamic resistance [m s-1] */
  ...
  strcpy(out_data[OUT_LONGWAVE].varname,"OUT_LONGWAVE");               /* incoming longwave [W m-2] */
  strcpy(out_data[OUT_PRESSURE].varname,"OUT_PRESSURE");               /* near surface atmospheric pressure [kPa] */
  strcpy(out_data[OUT_QAIR].varname,"OUT_QAIR");                       /* specific humidity [kg kg-1] */
  strcpy(out_data[OUT_REL_HUMID].varname,"OUT_REL_HUMID");             /* relative humidity [fraction]*/
  strcpy(out_data[OUT_SHORTWAVE].varname,"OUT_SHORTWAVE");             /* incoming shortwave [W m-2] */
  strcpy(out_data[OUT_SURF_COND].varname,"OUT_SURF_COND");             /* surface conductance [m s-1] */
  ...
  strcpy(out_data[OUT_WIND].varname,"OUT_WIND");                       /* near surface wind speed [m s-1] */
  ...
  strcpy(out_data[OUT_ADV_SENS_BAND].varname,"OUT_ADV_SENS_BAND");               /* net sensible heat flux advected to snow pack [W m-2] */
  strcpy(out_data[OUT_ADVECTION_BAND].varname,"OUT_ADVECTION_BAND");             /* advected energy [W m-2] */
  strcpy(out_data[OUT_ALBEDO_BAND].varname,"OUT_ALBEDO_BAND");                   /* albedo [fraction] */
  strcpy(out_data[OUT_DELTACC_BAND].varname,"OUT_DELTACC_BAND");                 /* change in cold content in snow pack [W m-2] */
  strcpy(out_data[OUT_GRND_FLUX_BAND].varname,"OUT_GRND_FLUX_BAND");             /* net heat flux into ground [W m-2] */
  strcpy(out_data[OUT_IN_LONG_BAND].varname,"OUT_IN_LONG_BAND");                 /* incoming longwave flux at surface (under veg) [W m-2] */
  strcpy(out_data[OUT_LATENT_BAND].varname,"OUT_LATENT_BAND");                   /* net upward latent heat flux [W m-2] */
  strcpy(out_data[OUT_LATENT_SUB_BAND].varname,"OUT_LATENT_SUB_BAND");           /* net upward latent heat flux from sublimation [W m-2] */
  strcpy(out_data[OUT_MELT_ENERGY_BAND].varname,"OUT_MELT_ENERGY_BAND");         /* energy of fusion (melting) [W m-2] */
  strcpy(out_data[OUT_NET_LONG_BAND].varname,"OUT_NET_LONG_BAND");               /* net downward longwave flux [W m-2] */
  strcpy(out_data[OUT_NET_SHORT_BAND].varname,"OUT_NET_SHORT_BAND");             /* net downward shortwave flux [W m-2] */
  strcpy(out_data[OUT_RFRZ_ENERGY_BAND].varname,"OUT_RFRZ_ENERGY_BAND");         /* net energy used to refreeze liquid water in snowpack [W m-2] */
  strcpy(out_data[OUT_SENSIBLE_BAND].varname,"OUT_SENSIBLE_BAND");               /* net upward sensible heat flux [W m-2] */
  ...
  strcpy(out_data[OUT_SNOW_FLUX_BAND].varname,"OUT_SNOW_FLUX_BAND");             /* energy flux through snow pack [W m-2] */
  strcpy(out_data[OUT_SNOW_MELT_BAND].varname,"OUT_SNOW_MELT_BAND");             /* snow melt [mm] (ALMA_OUTPUT: [mm s-1]) */
  ...
  out_data[OUT_SMLIQFRAC].nelem = vic411_options.Nlayer;
  out_data[OUT_SMFROZFRAC].nelem = vic411_options.Nlayer;
  out_data[OUT_SOIL_ICE].nelem = vic411_options.Nlayer;
  out_data[OUT_SOIL_LIQ].nelem = vic411_options.Nlayer;
  out_data[OUT_SOIL_MOIST].nelem = vic411_options.Nlayer;
  out_data[OUT_SOIL_TEMP].nelem = vic411_options.Nlayer;
#if EXCESS_ICE
  out_data[OUT_SOIL_DEPTH].nelem = vic411_options.Nlayer;
  out_data[OUT_SUBSIDENCE].nelem = vic411_options.Nlayer;
  out_data[OUT_POROSITY].nelem = vic411_options.Nlayer;
  out_data[OUT_ZSUM_NODE].nelem = vic411_options.Nnode;
#endif
  out_data[OUT_SOIL_TNODE].nelem = vic411_options.Nnode;
  out_data[OUT_SOIL_TNODE_WL].nelem = vic411_options.Nnode;
  out_data[OUT_SOILT_FBFLAG].nelem = vic411_options.Nnode;
  out_data[OUT_ADV_SENS_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_ADVECTION_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_ALBEDO_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_DELTACC_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_GRND_FLUX_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_IN_LONG_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_LATENT_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_LATENT_SUB_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_MELT_ENERGY_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_NET_LONG_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_NET_SHORT_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_RFRZ_ENERGY_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SENSIBLE_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_CANOPY_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_COVER_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_DEPTH_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_FLUX_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_MELT_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_PACKT_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SNOW_SURFT_BAND].nelem = vic411_options.SNOW_BAND;
  out_data[OUT_SWE_BAND].nelem = vic411_options.SNOW_BAND;
...
void vic411_init_output_list(vic411_out_data_struct *out_data, int write, char *format, int type, float mult) {
/*************************************************************
  vic411_init_output_list()      Ted Bohn     September 08, 2006
...
int vic411_set_output_var(vic411_out_data_file_struct *out_data_files,
                    int write,
                    int filenum,
                    vic411_out_data_struct *out_data,
                    char *varname,
                    ...
                    float mult) {
/*************************************************************
  vic411_set_output_var()      Ted Bohn     September 08, 2006
...
*************************************************************/
  ...
  if (!found) {
    status = -1;
    fprintf(stderr, "vic411_Error: vic411_set_output_var: \"%s\" was not found in the list of supported output variable names.  Please use the exact name listed in vic411_vicNl_def.h.\n", varname);
  }
  return status;
...
void vic411_zero_output_list(vic411_out_data_struct *out_data) {
/*************************************************************
  vic411_zero_output_list()      Ted Bohn     September 08, 2006
...
void vic411_free_out_data_files(vic411_out_data_file_struct **out_data_files) {
/*************************************************************
  vic411_free_out_data_files()      Ted Bohn     September 08, 2006
...
void vic411_free_out_data(vic411_out_data_struct **out_data) {
/*************************************************************
  vic411_free_out_data()      Ted Bohn     April 19, 2007
