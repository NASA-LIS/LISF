...
static char vcid[] = "$Id: vic411_calc_rainonly.c,v 5.2.2.2 2007/11/08 01:23:36 vicadmin Exp $";

double vic411_calc_rainonly(double air_temp,
		     double prec,
		     double MAX_SNOW_TEMP,
		     double MIN_RAIN_TEMP,
		     double mu) {
/**********************************************************************
  vic411_calc_rainonly.c	Keith Cherkauer		March 7, 1998
