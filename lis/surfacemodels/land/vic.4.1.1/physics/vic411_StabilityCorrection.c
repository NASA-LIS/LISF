/*
 * SUMMARY:      vic411_StabilityCorrection.c - Calculate the stability correction
 * USAGE:        Part of DHSVM
 *
 ...
 * DESCRIP-END.
 * FUNCTIONS:    vic411_StabilityCorrection()
 * COMMENTS:     
 */
...
static char vcid[] = "$Id: vic411_StabilityCorrection.c,v 5.2 2004/05/06 22:29:38 tbohn Exp $";

/*****************************************************************************
  Function name: vic411_StabilityCorrection()
  ...
  Comments     :
*****************************************************************************/
double vic411_StabilityCorrection(double Z, double d, double TSurf, double Tair, 
