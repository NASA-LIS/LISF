...
double vic411_read_arcinfo_value(char *filename,
			  double lat,
			  double lng) {
/**********************************************************************
  vic411_read_arcinfo_value           Keith Cherkauer           May 5, 1998
...
int vic411_read_arcinfo_info(char    *filename,
		      double **lat,
		      double **lng,
		      int    **cellnum) {
/**********************************************************************
  vic411_read_arcinfo_info           Keith Cherkauer           May 5, 1998
...
**********************************************************************/
  ...
  farc=vic411_open_file(filename,"r");
