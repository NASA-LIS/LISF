...
double vic411_calc_veg_displacement(double height) {
/**********************************************************************
  vic411_calc_veg_displacement		Keith Cherkauer		January 27, 1997
...
double vic411_calc_veg_height(double displacement) {
/**********************************************************************
  vic411_calc_veg_height		Keith Cherkauer		March 3, 1997
...
double vic411_calc_veg_roughness(double height) {
/**********************************************************************
  vic411_calc_veg_roughness		Keith Cherkauer		January 27, 1997
