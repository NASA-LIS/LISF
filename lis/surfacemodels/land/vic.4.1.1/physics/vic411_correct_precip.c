...
static char vcid[] = "$Id: vic411_correct_precip.c,v 4.2 2000/05/30 22:35:57 vicadmin Exp $";

#define GAUGE_HEIGHT 1.0  /* precipitation gauge height (m) */

void vic411_correct_precip(double *gauge_correction, 
		    double  wind,
		    double  wind_h,
		    double  roughness,
		    double  snow_roughness) {
/**********************************************************************
	vic411_correct_precip	Keith Cherkauer		May 21, 1997
