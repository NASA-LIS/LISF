...
static char vcid[] = "$Id: vic411_arno_evap.c,v 5.3.2.3 2009/06/09 09:54:10 vicadmin Exp $";
...
/****************************************************************************
  ...
  04-Jun-04 Changed logic of evap limit check to avoid creating spurious
	    ...
	    3) occasional inability for vic411_calc_surf_energy_bal to converge
	    in vic411_root_brent, and 4) spuriously high vic411_runoff and baseflow.
...
double vic411_arno_evap(vic411_layer_data_struct *layer_wet,
...
#endif
{
  ...
  for(dist=0;dist<Ndist;dist++) {
	...
	* frost_fract[frost_area];
    ...
    Epot = vic411_penman(air_temp, elevation, rad, vpd, ra, 0.0, 0.0) * delta_t / SEC_PER_DAY;
