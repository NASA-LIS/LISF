...
!BOP
!
! !ROUTINE: vic411_diagnoseoutputvar
! \label{vic411_diagnoseoutputvar}
!
! !REVISION HISTORY:
! Nov 2011; James Geiger, Initial implementation of VIC 4.1.1 into LIS.
! 
! !INTERFACE:
subroutine vic411_diagnoseoutputvar(nest, tile, moc_index, vlevel, value, &
...
end subroutine vic411_diagnoseoutputvar
