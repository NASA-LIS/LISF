...
!BOP
!
! !ROUTINE: noah271_setwrfexport.F90
!
! !DESCRIPTION:  
...
! 02 Dec 2015; Eric Kemp, Updated for LIS 7.1
! 
! !INTERFACE:
subroutine noah271_setwrfexport(n)
! !USES:
  use ESMF
  use LIS_coreMod
