...
!BOP
! !ROUTINE: noah271_updatesnowvars
! \label{noah271_updatesnowvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah271_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
! !DESCRIPTION:
!
!  Updates and returns the snow related state prognostic variables for
!  data assimilation
! 
!  The arguments are: 
!  \begin{description}
...
!     if(t.le.12) & 
!          write(LIS_logunit,*) 'upd ',t, swe(t), snod(t), sweincr(t), snodincr(t)
  enddo
end subroutine noah271_updatesnowvars
