...
!BOP
! !ROUTINE: noah271_updatescfvars
! \label{noah271_updatescfvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah271_updatescfvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
end subroutine noah271_updatescfvars
