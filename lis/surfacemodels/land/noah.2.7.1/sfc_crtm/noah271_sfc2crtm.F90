...
#include "LIS_misc.h"
!BOP
! !ROUTINE: noah271_sfc2crtm
! \label{noah271_sfc2crtm}
!
! !REVISION HISTORY:
!  37 Mar 2009: Sujay Kumar; Initial Code
!
! !INTERFACE:
subroutine noah271_sfc2crtm(n, sfcState)
! !USES:      
  use ESMF
...
!EOP
  ...
  do t=1,LIS_rc%ntiles(n)
     ...
     Snow_Depth(t) = noah271_struc(n)%noah(t)%snowh *1000.0
     if(noah271_struc(n)%noah(t)%sneqv.gt.0)  then 
        ...
        Snow_Density(t) =1000000.0*  noah271_struc(n)%noah(t)%sneqv &
             /  &
  ...
  enddo
end subroutine noah271_sfc2crtm
