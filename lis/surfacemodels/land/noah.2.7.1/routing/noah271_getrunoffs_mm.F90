...
!BOP
! !ROUTINE: noah271_getrunoffs_mm
!  \label{noah271_getrunoffs_mm}
!
! !REVISION HISTORY:
!  6 May 2011: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noah271_getrunoffs_mm(n)
  ! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !mm
     runoff1(t) = noah271_struc(n)%noah(t)%runoff1*1000.0
     runoff2(t) = noah271_struc(n)%noah(t)%runoff2*1000.0 
  enddo
...
end subroutine noah271_getrunoffs_mm
