...
!BOP
! !ROUTINE: noah271_descale_soilm
! \label{noah271_descale_soilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah271_descale_soilm(n, LSM_State, LSM_Incr_State)
...
end subroutine noah271_descale_soilm
