...
!BOP
! !ROUTINE: noah271_updatemultism
!  \label{noah271_updatemultism}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah271_updatemultism(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  real, allocatable          :: soilmIncr1(:)
  real, allocatable          :: soilmIncr2(:)
  real, allocatable          :: soilmIncr3(:)
  real, allocatable          :: soilmIncr4(:)
  integer                :: t
  integer                :: status
  ...
  enddo
end subroutine noah271_updatemultism
