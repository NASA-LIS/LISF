...
!BOP
! !ROUTINE: noah271_updatesnwdvars
! \label{noah271_updatesnwdvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah271_updatesnwdvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!     swe(t) = swe(t) + sweincr(t)
  ...
  enddo
end subroutine noah271_updatesnwdvars
