...
!BOP
!
! !ROUTINE: noah32_setwrfexport.F90
!
! !DESCRIPTION:  
...
! 02 Dec 2003; Eric Kemp, Updated for LIS 7.1
! 
! !INTERFACE:
subroutine noah32_setwrfexport(n)
! !USES:
  use ESMF
  use LIS_coreMod
