...
#include "LIS_misc.h"
!BOP
! !ROUTINE: noah32_sfc2cmem3
! \label{noah32_sfc2cmem3}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah32_sfc2cmem3(n, sfcState)
! !USES:      
  use ESMF
...
!EOP
  ...
  do t=1,LIS_rc%ntiles(n)
     ...
     Snow_Depth(t) = noah32_struc(n)%noah(t)%snowh 
     ...
     if(noah32_struc(n)%noah(t)%sneqv.gt.0)  then 
        ...
        Snow_Density(t) = noah32_struc(n)%noah(t)%sneqv &
  ...
  enddo
end subroutine noah32_sfc2cmem3
