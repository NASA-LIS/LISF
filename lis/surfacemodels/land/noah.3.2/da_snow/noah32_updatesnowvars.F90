...
!BOP
! !ROUTINE: noah32_updatesnowvars
! \label{noah32_updatesnowvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah32_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  enddo
end subroutine noah32_updatesnowvars
