...
! save snow density for SCA DA via direct insertion - yliu17
                       sndens,                                          &
...
! ----------------------------------------------------------------------
      ...
      REAL,INTENT(OUT)   :: EVP, ETA_KINEMATIC,BETA,DEW,DRIP,EC,EDIR,ESNOW,ETA,  &
                            ...
                            SOILW,FDOWN,Q1,SNDENS !sndens added by yliu17
...
!yliu17              RSNOW,SNDENS,SNCOND,SBETA,SN_NEW,SNUP,SALP,SOILWM,      &
              RSNOW,SNCOND,SBETA,SN_NEW,SNUP,SALP,SOILWM,      &  !SNDENS removed by yliu17, it is now an output
...
END MODULE module_sf_noah32lsm
