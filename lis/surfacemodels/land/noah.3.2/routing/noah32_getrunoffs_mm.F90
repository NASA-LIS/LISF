...
!BOP
! !ROUTINE: noah32_getrunoffs_mm
!  \label{noah32_getrunoffs_mm}
!
! !REVISION HISTORY:
!  6 May 2011: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noah32_getrunoffs_mm(n)
! !USES:
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = noah32_struc(n)%noah(t)%runoff1*LIS_CONST_RHOFW
     runoff2(t) = noah32_struc(n)%noah(t)%runoff2*LIS_CONST_RHOFW 
  enddo
...
end subroutine noah32_getrunoffs_mm
