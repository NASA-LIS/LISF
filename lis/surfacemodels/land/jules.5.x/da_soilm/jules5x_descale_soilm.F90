...
!BOP
! !ROUTINE: jules5x_descale_soilm
! \label{jules5x_descale_soilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_descale_soilm(n, LSM_State, LSM_Incr_State)
...
end subroutine jules5x_descale_soilm
