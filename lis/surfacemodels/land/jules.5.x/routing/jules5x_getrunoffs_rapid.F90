...
!BOP
! !ROUTINE: jules5x_getrunoffs_rapid
!  \label{jules5x_getrunoffs_rapid}
!
! !REVISION HISTORY:
! 19 May 2021: Yeosang Yoon; Initial Specification 
!
! !INTERFACE:
subroutine jules5x_getrunoffs_rapid(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = jules5x_struc(n)%jules5x(t)%surf_roff
     runoff2(t) = jules5x_struc(n)%jules5x(t)%sub_surf_roff
  enddo
...
end subroutine jules5x_getrunoffs_rapid
