...
!BOP
! !ROUTINE: jules5x_descale_usafsi
! \label{jules5x_descale_usafsi}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_descale_usafsi(n, LSM_State, LSM_Incr_State)
...
!  \end{description}
!EOP
end subroutine jules5x_descale_usafsi
