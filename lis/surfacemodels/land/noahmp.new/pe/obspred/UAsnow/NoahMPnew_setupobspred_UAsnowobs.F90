...
!BOP
! !ROUTINE: NoahMPnew_setupobspred_UAsnowobs
!  \label{NoahMPnew_setupobspred_UAsnowobs}
!
! !REVISION HISTORY:
! 2 May 2020: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine NoahMPnew_setupobspred_UAsnowobs(OBSPred)
! !USES:
  use ESMF
...
!  NoahMP used for parameter estimation
! 
!EOP
  integer                :: n
...
end subroutine NoahMPnew_setupobspred_UAsnowobs
