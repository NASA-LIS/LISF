...
!BOP
! !ROUTINE: noahmpnew_updatevegvars
!  \label{noahmpnew_updatevegvars}
!
! !REVISION HISTORY:
! 13 Feb 2020: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noahmpnew_updatevegvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
end subroutine noahmpnew_updatevegvars
