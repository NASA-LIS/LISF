...
!BOP
! !ROUTINE: noahmpnew_getLAIpred
! \label{noahmpnew_getLAIpred}
!
! !REVISION HISTORY:
! 13 Feb 2020: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noahmpnew_getLAIpred(n, k,obs_pred)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)
     lai(t) = NoahMPnew_struc(n)%noahmpnew(t)%lai
  enddo
...
end subroutine noahmpnew_getLAIpred
