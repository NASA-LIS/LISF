...
!BOP
! !ROUTINE: NoahMPnew_updatesoilm
!  \label{NoahMPnew_updatesoilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine NoahMPnew_updatesoilm(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 1 failed in NoahMPnew_updatesoilm")
  call ESMF_StateGet(LSM_State,"Soil Moisture Layer 2",sm2Field,rc=status)
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 2 failed in NoahMPnew_updatesoilm")
  call ESMF_StateGet(LSM_State,"Soil Moisture Layer 3",sm3Field,rc=status)
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 3 failed in NoahMPnew_updatesoilm")
  call ESMF_StateGet(LSM_State,"Soil Moisture Layer 4",sm4Field,rc=status)
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 4 failed in NoahMPnew_updatesoilm")
  ...
  enddo
end subroutine NoahMPnew_updatesoilm
