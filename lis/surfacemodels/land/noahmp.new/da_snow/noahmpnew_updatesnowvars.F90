...
!BOP
! !ROUTINE: noahmpnew_updatesnowvars
! \label{noahmpnew_updatesnowvars}
!
! !REVISION HISTORY:
...
! !INTERFACE:
subroutine noahmpnew_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noahmpnew_updatesnowvars
