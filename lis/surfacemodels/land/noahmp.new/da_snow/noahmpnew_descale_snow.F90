...
!BOP
! !ROUTINE: noahmpnew_descale_snow
! \label{noahmpnew_descale_snow}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_descale_snow(n, LSM_State, LSM_Incr_State)
...
end subroutine noahmpnew_descale_snow
