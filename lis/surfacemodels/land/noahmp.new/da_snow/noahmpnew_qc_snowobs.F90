...
!BOP
! !ROUTINE: noahmpnew_qc_snowobs
! \label{noahmpnew_qc_snowobs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_qc_snowobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  call LIS_verify(status,&
       "ESMF_StateGet failed in noahmpnew_qc_snowobs")
  call ESMF_FieldGet(obs_snow_field,localDE=0,farrayPtr=snowobs,rc=status)
  call LIS_verify(status,&
       "ESMF_FieldGet failed in noahmpnew_qc_snowobs")
...
end subroutine noahmpnew_qc_snowobs
