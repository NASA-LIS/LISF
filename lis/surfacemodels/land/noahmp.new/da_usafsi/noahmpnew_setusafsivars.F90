...
!BOP
! !ROUTINE: noahmpnew_setusafsivars
! \label{noahmpnew_setusafsivars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_setusafsivars(n, LSM_State)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     ! update
     call noahmpnew_usafsi_update(n, t, dsneqv, dsnowh)
...
end subroutine noahmpnew_setusafsivars
