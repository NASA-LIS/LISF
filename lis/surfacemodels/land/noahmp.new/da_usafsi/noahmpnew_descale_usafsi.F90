...
!BOP
! !ROUTINE: noahmpnew_descale_usafsi
! \label{noahmpnew_descale_usafsi}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_descale_usafsi(n, LSM_State, LSM_Incr_State)
...
end subroutine noahmpnew_descale_usafsi
