...
!BOP
! !ROUTINE: noahmpnew_updateusafsivars
! \label{noahmpnew_updateusafsivars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_updateusafsivars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noahmpnew_updateusafsivars
