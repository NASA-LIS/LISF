...
!BOP
! !ROUTINE: noahmpnew_getusafsipred
! \label{noahmpnew_getusafsipred}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_getusafsipred(n, k, obs_pred)
...
!  instances.
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     snwd(t) = NoahmpNew_struc(n)%noahmpnew(t)%snowh ! Keep in meters
  enddo
...
end subroutine noahmpnew_getusafsipred
