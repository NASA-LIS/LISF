...
module noahmpnew_tws_DAlogMod
  
  use LIS_constantsMod,  only : LIS_CONST_RHOFW
  use ESMF
! !PUBLIC MEMBER FUNCTIONS:
!------------------------------------------
  public :: noahmpnew_tws_DAlog
!-----------------------------------------
! !PUBLIC TYPES:
!-----------------------------------------
...
contains 
  ...
  subroutine noahmpnew_tws_DAlog(n)
          ...
          if(((LIS_rc%da.eq.5).and.(LIS_rc%hr.eq.4).and.(LIS_rc%mn.eq.0)).or. &
             ...
             do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
                NOAHMPpred_struc(n)%clmnwater(d,t)= &
                     NOAHMPpred_struc(n)%clmnwater(d,t) + &
                     NoahMPnew_struc(n)%noahmpnew(t)%sneqv   +         &
                     (NoahMPnew_struc(n)%noahmpnew(t)%canliq  +         &
                     NoahMPnew_struc(n)%noahmpnew(t)%canice) +         &
                     (NoahMPnew_struc(n)%noahmpnew(t)%smc(1)  *         &
                     NoahMPnew_struc(n)%sldpth(1)*LIS_CONST_RHOFW)        +         &
                     (NoahMPnew_struc(n)%noahmpnew(t)%smc(2)  *         &
                     NoahMPnew_struc(n)%sldpth(2)*LIS_CONST_RHOFW)        +         &
                     (NoahMPnew_struc(n)%noahmpnew(t)%smc(3)  *         &
                     NoahMPnew_struc(n)%sldpth(3)*LIS_CONST_RHOFW)        +         &
                     (NoahMPnew_struc(n)%noahmpnew(t)%smc(4)  *         &
                     NoahMPnew_struc(n)%sldpth(4)*LIS_CONST_RHOFW)        +         &
                     NoahMPnew_struc(n)%noahmpnew(t)%wa                   
             enddo
          endif
  ...
  end subroutine noahmpnew_tws_DAlog
  
end module noahmpnew_tws_DAlogMod
