...
!BOP
! !ROUTINE: noahmpnew_updatesnodepvars
! \label{noahmpnew_updatesnodepvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_updatesnodepvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noahmpnew_updatesnodepvars
