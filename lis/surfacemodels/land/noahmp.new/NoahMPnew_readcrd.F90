...
!EOP
    ...
    do n=1, LIS_rc%nnest
        ...
        NoahmpNew_struc(n)%LDT_ncvar_fdepth         = 'FDEPTH'
        NoahmpNew_struc(n)%LDT_ncvar_eqzwt          = 'EQZWT'
        NoahmpNew_struc(n)%LDT_ncvar_rechclim       = 'RECHCLIM'
        NoahmpNew_struc(n)%LDT_ncvar_riverbed       = 'RIVERBED'
    enddo
