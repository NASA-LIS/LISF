...
!BOP
!
! !ROUTINE: NoahMPnew_setwrfexport.F90
!
! !DESCRIPTION:  
!  Defines the export states from NoahMP to WRF in coupled mode
...
! 
! !INTERFACE:
subroutine NoahMPnew_setwrfexport(n)
! !USES:
  use ESMF
  use LIS_coreMod
