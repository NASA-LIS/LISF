...
!BOP
! !ROUTINE: noahmpnew_setCROCUSimport
! \label{noahmpnew_setCROCUSimport}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_setCROCUSimport(n, SubLSM2LSM_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
end subroutine noahmpnew_setCROCUSimport
