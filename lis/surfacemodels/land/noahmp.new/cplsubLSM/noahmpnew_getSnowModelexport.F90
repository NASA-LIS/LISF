...
!BOP
! !ROUTINE: noahmpnew_getSnowModelexport
! \label{noahmpnew_getSnowModelexport}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmpnew_getSnowModelexport(n, LSM2SUBLSM_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
end subroutine noahmpnew_getSnowModelexport
