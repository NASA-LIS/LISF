...
....
$ cd LISF/lis/surfacemodels/land/jules.5.0/
$ cp -r <path_to_jules>/jules.5.0/src .
$ cp -r <path_to_jules>/jules.5.0/utils .
$ ./couple_jules_to_lis.sh
....

IMPORTANT: Do *not* commit the LISF/lis/surfacemodels/land/jules.5.0/src and LISF/lis/surfacemodels/land/jules.5.0/utils sub-directories into git.  These do not belong to NASA-LIS.
