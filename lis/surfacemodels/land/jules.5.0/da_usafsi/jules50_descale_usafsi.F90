...
!BOP
! !ROUTINE: jules50_descale_usafsi
! \label{jules50_descale_usafsi}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules50_descale_usafsi(n, LSM_State, LSM_Incr_State)
...
!  \end{description}
!EOP
end subroutine jules50_descale_usafsi
