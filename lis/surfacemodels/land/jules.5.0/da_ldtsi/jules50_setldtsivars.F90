...
!BOP
! !ROUTINE: jules50_setldtsivars
! \label{jules50_setldtsivars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules50_setldtsivars(n, LSM_State)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     call jules50_ldtsi_update(n, t, dsneqv, dsnowh)

  enddo
  
end subroutine jules50_setldtsivars
