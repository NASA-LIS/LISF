  ...
  do n=1, LIS_rc%nnest
     ...
     if(LIS_rc%uselcmap(n) .ne. 'none') then
        ...
        do t=1, LIS_rc%npatch(n, mtype)
           NoahMP50_struc(n)%noahmp50(t)%vegetype= &
                LIS_surface(n, mtype)%tile(t)%vegt
        enddo
     else
        ! read: vegetype
        write(LIS_logunit,*) &
        ...
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_vegetype), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
     ...
     if(LIS_rc%usetexturemap(n) .ne. 'none') then
        ...
        do t=1, LIS_rc%npatch(n, mtype)
           NoahMP50_struc(n)%noahmp50(t)%soiltype= &
                LIS_surface(n, mtype)%tile(t)%soilt
        enddo
     else
        ! read: soiltype
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_soiltype), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
     ...
     write(LIS_logunit,*) &
          ...
          trim(LIS_rc%paramfile(n))
     call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_tbot), &
          placeholder)
     do t = 1, LIS_rc%npatch(n, mtype)
        col = LIS_surface(n, mtype)%tile(t)%col
        row = LIS_surface(n, mtype)%tile(t)%row
     ...
     if(NoahMP50_struc(n)%crop_opt > 0) then
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_planting), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        ! read: harvest
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter HARVEST from ",&
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_harvest), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        ! read: season_gdd
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter SEASON_GDD from ", &
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_season_gdd),&
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
     ...
     if(NoahMP50_struc(n)%irr_opt > 0) then
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_irfract), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_sifract), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_mifract), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_fifract), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
     ...
     if(NoahMP50_struc(n)%tdrn_opt > 0) then
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_tdfract), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
     ...
     if(NoahMP50_struc(n)%soil_opt .eq. 2) then
        ! read: soilcL1
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter SOILCL1 from ", &
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_soilcL1), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        ! read: soilcL2
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter SOILCL2 from ", &
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_soilcL2), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        ! read: soilcL3
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter SOILCL3 from ", &
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_soilcL3), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        ! read: soilcL4
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter SOILCL4 from ", &
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_soilcL4), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
     ...
     if(NoahMP50_struc(n)%runsub_opt == 5) then
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_fdepth), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_eqzwt), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_riverbed), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
        ...
        write(LIS_logunit,*) &
             ...
             trim(LIS_rc%paramfile(n))
        call LIS_read_param(n, trim(NoahMP50_struc(n)%LDT_ncvar_rechclim), &
             placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
     ...
     write(LIS_logunit,*) &
          "[INFO] Noah-MP.5.0 reading parameter SHDFAC_MONTHLY from ",&
          trim(LIS_rc%paramfile(n))
     do k = 1, 12
        call NoahMP50_read_MULTILEVEL_param(n, &
             NoahMP50_struc(n)%LDT_ncvar_shdfac_monthly, k, placeholder)
        do t = 1, LIS_rc%npatch(n, mtype)
           col = LIS_surface(n, mtype)%tile(t)%col
           row = LIS_surface(n, mtype)%tile(t)%row
           NoahMP50_struc(n)%noahmp50(t)%shdfac_monthly(k) = &
                placeholder(col, row)
        enddo
     enddo
     ...
     if(NoahMP50_struc(n)%soil_opt .eq. 3) then
        ! read: soilcomp
        write(LIS_logunit,*) &
             "[INFO] Noah-MP.5.0 reading parameter SOILCOMP from ", &
             trim(LIS_rc%paramfile(n))
        do k = 1, 8
           call NoahMP50_read_MULTILEVEL_param(n, &
                NoahMP50_struc(n)%LDT_ncvar_soilcomp, k, placeholder)
           do t = 1, LIS_rc%npatch(n, mtype)
              col = LIS_surface(n, mtype)%tile(t)%col
              row = LIS_surface(n, mtype)%tile(t)%row
              NoahMP50_struc(n)%noahmp50(t)%soilcomp(k) = &
                   placeholder(col, row)
           enddo
        enddo
     endif
...
!!!! read Noah-MP parameter tables
     write(LIS_logunit,*) &
          "[INFO] Noah-MP.5.0 parameter table (veg, soil, general): ", &
          trim(NoahMP50_struc(n)%noahmp_tbl_name)
     write(LIS_logunit,*) &
          "[INFO] Noah-MP.5.0 Landuse classification scheme: ", &
          trim(NoahMP50_struc(n)%landuse_scheme_name)
     write(LIS_logunit,*) &
          "[INFO] Noah-MP.5.0 Soil classification scheme: ",  &
     ...
     do t=1,LIS_rc%npatch(n,mtype)
        ...
        CROPTYPE     = 0
        if (NoahMP50_struc(n)%crop_opt > 0 .and. &
             VEGTYP == NoahmpIO%ISCROP_TABLE) &
             CROPTYPE = NoahmpIO%DEFAULT_CROP_TABLE
        call TRANSFER_MP_PARAMETERS_NEW(VEGTYP,SOILTYP,SLOPETYP,SOILCOLOR,&
             CROPTYPE, NoahMP50_struc(n)%noahmp50(t)%param)
     enddo
...
!EOP
  ...
  if(file_exists) then
     ...
     ios = nf90_open(path=trim(LIS_rc%paramfile(n)), mode=NF90_NOWRITE, &
          ncid=nid)
     call LIS_verify(ios, 'Error in nf90_open in '// &
          'NoahMP50_read_MULTILEVEL_param')

     ! inquire the ID of east-west dimension
     ios = nf90_inq_dimid(nid, 'east_west', nc_ID)
     call LIS_verify(ios, 'Error in nf90_inq_dimid in '// &
          'NoahMP50_read_MULTILEVEL_param')
     ...
     call LIS_verify(ios, 'Error in nf90_inquire_dimension in '// &
          'NoahMP50_read_MULTILEVEL_param')
     ...
     ! inquire the IDs of all dimensions. The third dimension is the level
     ! dimension
     ...
     call LIS_verify(ios, trim(ncvar_name)// &
          ' failed to inquire the length of the 3rd dimension')
     ...
     call LIS_verify(ios, &
          'Error in nf90_get_var in NoahMP50_read_MULTILEVEL_param')

     ! close netcdf file
     ios = nf90_close(nid)
     call LIS_verify(ios, &
          'Error in nf90_close in NoahMP50_read_MULTILEVEL_param')

     ! grab parameter at specific level
     placeholder(:, :) = &
          level_data(LIS_ews_halo_ind(n, &
          LIS_localPet+1):LIS_ewe_halo_ind(n, LIS_localPet+1), &
          LIS_nss_halo_ind(n, LIS_localPet+1): &
          LIS_nse_halo_ind(n, LIS_localPet+1), level)
...
SUBROUTINE TRANSFER_MP_PARAMETERS_NEW(VEGTYPE,SOILTYPE,SLOPETYPE,SOILCOLOR,&
     CROPTYPE,parameters)
  ...
  IF( VEGTYPE == NoahmpIO%ISURBAN_TABLE .or. &
       VEGTYPE >= NoahmpIO%URBTYPE_beg ) THEN
...
!------------------------------------------------------------------------------
  ...
  parameters%CH2OP   =  NoahmpIO%CH2OP_TABLE(VEGTYPE) ! maximum intercepted
                                                      ! h2o per unit lai+sai
                                                      ! (mm)
  parameters%DLEAF   =  NoahmpIO%DLEAF_TABLE(VEGTYPE) ! characteristic leaf
                                                      ! dimension (m)
  parameters%Z0MVT   =  NoahmpIO%Z0MVT_TABLE(VEGTYPE) ! momentum roughness
                                                      ! length (m)
  parameters%HVT     =    NoahmpIO%HVT_TABLE(VEGTYPE) ! top of canopy (m)
  parameters%HVB     =    NoahmpIO%HVB_TABLE(VEGTYPE) ! bottom of canopy (m)
  parameters%DEN     =    NoahmpIO%DEN_TABLE(VEGTYPE) ! tree density (no. of
                                                      ! trunks per m2)
  ...
  parameters%SCFFAC  = NoahmpIO%SCFFAC_TABLE(VEGTYPE) ! snow cover factor (m)
                                                      ! (replace original
                                                      ! hard-coded 2.5*z0 in
                                                      ! SCF formulation)
  parameters%CBIOM   =  NoahmpIO%CBIOM_TABLE(VEGTYPE) ! canopy biomass heat
                                                      ! capacity parameter (m)
  parameters%SAIM    =   NoahmpIO%SAIM_TABLE(VEGTYPE,:) ! monthly stem area
                                                        ! index, one-sided
  parameters%LAIM    =   NoahmpIO%LAIM_TABLE(VEGTYPE,:) ! monthly leaf area
                                                        ! index, one-sided
  parameters%SLA     =    NoahmpIO%SLA_TABLE(VEGTYPE)   ! single-side leaf
                                                        ! area per Kg [m2/kg]
  parameters%DILEFC  = NoahmpIO%DILEFC_TABLE(VEGTYPE)   ! coefficient for leaf
                                                        ! stress death [1/s]
  parameters%DILEFW  = NoahmpIO%DILEFW_TABLE(VEGTYPE)   ! coefficient for leaf
                                                        ! stress death [1/s]
  parameters%FRAGR   =  NoahmpIO%FRAGR_TABLE(VEGTYPE)   ! fraction of growth
                                                        ! respiration
  parameters%LTOVRC  = NoahmpIO%LTOVRC_TABLE(VEGTYPE)   ! leaf turnover [1/s]
  parameters%C3PSN   =  NoahmpIO%C3PSN_TABLE(VEGTYPE)   ! photosynthetic
                                                        ! pathway: 0. = c4,
                                                        ! 1. = c3
  parameters%KC25    =   NoahmpIO%KC25_TABLE(VEGTYPE)   ! co2 michaelis-menten
                                                        ! constant at 25c (pa)
  parameters%AKC     =    NoahmpIO%AKC_TABLE(VEGTYPE)   ! q10 for kc25
  parameters%KO25    =   NoahmpIO%KO25_TABLE(VEGTYPE)   ! o2 michaelis-menten
                                                        ! constant at 25c (pa)
  parameters%AKO     =    NoahmpIO%AKO_TABLE(VEGTYPE)   ! q10 for ko25
  parameters%VCMX25  = NoahmpIO%VCMX25_TABLE(VEGTYPE)   ! maximum rate of
                                                        ! carboxylation at
                                                        ! 25c (umol co2/m**2/s)
  parameters%AVCMX   =  NoahmpIO%AVCMX_TABLE(VEGTYPE)   ! q10 for vcmx25
  parameters%BP      =     NoahmpIO%BP_TABLE(VEGTYPE)   ! minimum leaf
                                                        ! conductance
                                                        ! (umol/m**2/s)
  parameters%MP      =     NoahmpIO%MP_TABLE(VEGTYPE)   ! slope of
                                                        ! conductance-to-
                                                        ! photosynthesis
                                                        ! relationship
  parameters%QE25    =   NoahmpIO%QE25_TABLE(VEGTYPE)   ! quantum efficiency
                                                        ! at 25c
                                                        ! (umol co2 /
                                                        ! umol photon)
  parameters%AQE     =    NoahmpIO%AQE_TABLE(VEGTYPE)   ! q10 for qe25
  parameters%RMF25   =  NoahmpIO%RMF25_TABLE(VEGTYPE)   ! leaf maintenance
                                                        ! respiration at 25c
                                                        ! (umol co2/m**2/s)
  parameters%RMS25   =  NoahmpIO%RMS25_TABLE(VEGTYPE)   ! stem maintenance
                                                        ! respiration at 25c
                                                        ! (umol co2/kg bio/s)
  parameters%RMR25   =  NoahmpIO%RMR25_TABLE(VEGTYPE)   ! root maintenance
                                                        ! respiration at 25c
                                                        ! (umol co2/kg bio/s)
  parameters%ARM     =    NoahmpIO%ARM_TABLE(VEGTYPE)   ! q10 for maintenance
                                                        ! respiration
  parameters%FOLNMX  = NoahmpIO%FOLNMX_TABLE(VEGTYPE)   ! foliage nitrogen
                                                        ! concentration when
                                                        ! f(n)=1 (%)
  parameters%TMIN    =   NoahmpIO%TMIN_TABLE(VEGTYPE)   ! minimum temperature
                                                        ! for photosynthesis
                                                        ! (K)
  parameters%XL      =     NoahmpIO%XL_TABLE(VEGTYPE)   ! leaf/stem
                                                        ! orientation index
  parameters%RHOL    =   NoahmpIO%RHOL_TABLE(VEGTYPE,:) ! leaf reflectance:
                                                        ! 1=vis, 2=nir
  parameters%RHOS    =   NoahmpIO%RHOS_TABLE(VEGTYPE,:) ! stem reflectance:
                                                        ! 1=vis, 2=nir
  parameters%TAUL    =   NoahmpIO%TAUL_TABLE(VEGTYPE,:) ! leaf transmittance:
                                                        ! 1=vis, 2=nir
  parameters%TAUS    =   NoahmpIO%TAUS_TABLE(VEGTYPE,:) ! stem transmittance:
                                                        ! 1=vis, 2=nir
  parameters%MRP     =    NoahmpIO%MRP_TABLE(VEGTYPE)   ! microbial
                                                        ! respiration
                                                        ! parameter
                                                        ! (umol co2 /kg c/ s)
  parameters%CWPVT   =  NoahmpIO%CWPVT_TABLE(VEGTYPE)   ! empirical canopy
                                                        ! wind parameter
  parameters%WRRAT   =  NoahmpIO%WRRAT_TABLE(VEGTYPE)   ! wood to non-wood
                                                        ! ratio
  parameters%WDPOOL  = NoahmpIO%WDPOOL_TABLE(VEGTYPE)   ! wood pool (switch 1
                                                        ! or 0) depending on
                                                        ! woody or not [-]
  parameters%TDLEF   =  NoahmpIO%TDLEF_TABLE(VEGTYPE)   ! characteristic T for
                                                        ! leaf freezing [K]
  parameters%NROOT   =  NoahmpIO%NROOT_TABLE(VEGTYPE)   ! number of soil
                                                        ! layers with root
                                                        ! present
  parameters%RGL     =    NoahmpIO%RGL_TABLE(VEGTYPE)   ! Parameter used in
                                                        ! radiation stress
                                                        ! function
  parameters%RSMIN   =     NoahmpIO%RS_TABLE(VEGTYPE)   ! Minimum stomatal
                                                        ! resistance [s m-1]
  parameters%HS      =     NoahmpIO%HS_TABLE(VEGTYPE)   ! Parameter used in
                                                        ! vapor pressure
                                                        ! deficit function
  parameters%TOPT    =   NoahmpIO%TOPT_TABLE(VEGTYPE)   ! Optimum
                                                        ! transpiration air
                                                        ! temperature [K]
  parameters%RSMAX   =  NoahmpIO%RSMAX_TABLE(VEGTYPE)   ! Maximal stomatal
                                                        ! resistance [s m-1]
  parameters%RTOVRC  = NoahmpIO%RTOVRC_TABLE(VEGTYPE)   ! root turnover
                                                        ! coefficient [1/s]
  parameters%RSWOODC = NoahmpIO%RSWOODC_TABLE(VEGTYPE)  ! wood respiration
                                                        ! coefficient [1/s]
  parameters%BF      =     NoahmpIO%BF_TABLE(VEGTYPE)   ! parameter for
                                                        ! present wood
                                                        ! allocation [-]
  parameters%WSTRC   =  NoahmpIO%WSTRC_TABLE(VEGTYPE)   ! water stress
                                                        ! coefficient [-]
  parameters%LAIMIN  = NoahmpIO%LAIMIN_TABLE(VEGTYPE)   ! minimum leaf area
                                                        ! index [m2/m2]
  parameters%XSAMIN  = NoahmpIO%XSAMIN_TABLE(VEGTYPE)   ! minimum stem area
                                                        ! index [m2/m2]
...
!------------------------------------------------------------------------------
  ...
  IF(CROPTYPE > 0) THEN
     ...
     parameters%PLANTPOP  =  NoahmpIO%PLANTPOP_TABLE(CROPTYPE) ! Plant density
                                                             ! [per ha] - used?
     parameters%IRRI      =      NoahmpIO%IRRI_TABLE(CROPTYPE) ! Irrigation
                                                            ! strategy
                                                            ! 0=no irrigation
                                                            ! 1=irrigation
                                                            ! (no water-stress)
     parameters%GDDTBASE  =  NoahmpIO%GDDTBASE_TABLE(CROPTYPE) ! Base
                                         ! temperature for GDD accumulation [C]
     parameters%GDDTCUT   =   NoahmpIO%GDDTCUT_TABLE(CROPTYPE) ! Upper
                                         ! temperature for GDD accumulation [C]
     parameters%GDDS1     =     NoahmpIO%GDDS1_TABLE(CROPTYPE) ! GDD from
                                                         ! seeding to emergence
     parameters%GDDS2     =     NoahmpIO%GDDS2_TABLE(CROPTYPE) ! GDD from
                                                ! seeding to initial vegetative
     parameters%GDDS3     =     NoahmpIO%GDDS3_TABLE(CROPTYPE) ! GDD from
                                                ! seeding to post vegetative
     ...
     parameters%AREF      =      NoahmpIO%AREF_TABLE(CROPTYPE) ! reference
                                                ! maximum CO2 assimulation rate
     parameters%PSNRF     =     NoahmpIO%PSNRF_TABLE(CROPTYPE) ! CO2
             ! assimilation reduction factor(0-1) (caused by non-modeling part,
             ! e.g.pest,weeds)
     parameters%I2PAR     =     NoahmpIO%I2PAR_TABLE(CROPTYPE) ! Fraction of
              ! incoming solar radiation to photosynthetically active radiation
     parameters%TASSIM0   =   NoahmpIO%TASSIM0_TABLE(CROPTYPE) ! Minimum
                                         ! temperature for CO2 assimulation [C]
     ...
     parameters%EPSI      =      NoahmpIO%EPSI_TABLE(CROPTYPE) ! initial light
                                                               ! use efficiency
     parameters%Q10MR     =     NoahmpIO%Q10MR_TABLE(CROPTYPE) ! q10 for
                                                     ! maintainance respiration
     parameters%LEFREEZ   =   NoahmpIO%LEFREEZ_TABLE(CROPTYPE) ! characteristic
                                                      ! T for leaf freezing [K]
     parameters%DILE_FC   =   NoahmpIO%DILE_FC_TABLE(CROPTYPE,:) ! coefficient
                                      ! for temperature leaf stress death [1/s]
     parameters%DILE_FW   =   NoahmpIO%DILE_FW_TABLE(CROPTYPE,:) ! coefficient
                                            ! for water leaf stress death [1/s]
     parameters%FRA_GR    =    NoahmpIO%FRA_GR_TABLE(CROPTYPE) ! fraction of
                                                           ! growth respiration
     parameters%LF_OVRC   =   NoahmpIO%LF_OVRC_TABLE(CROPTYPE,:) ! fraction of
                                                         ! leaf turnover  [1/s]
     parameters%ST_OVRC   =   NoahmpIO%ST_OVRC_TABLE(CROPTYPE,:) ! fraction of
                                                         ! stem turnover  [1/s]
     parameters%RT_OVRC   =   NoahmpIO%RT_OVRC_TABLE(CROPTYPE,:) ! fraction of
                                                         ! root turnover  [1/s]
     parameters%LFMR25    =    NoahmpIO%LFMR25_TABLE(CROPTYPE) ! leaf
                           ! maintenance respiration at 25C [umol CO2/m**2  /s]
     parameters%STMR25    =    NoahmpIO%STMR25_TABLE(CROPTYPE) ! stem
                           ! maintenance respiration at 25C [umol CO2/kg bio/s]
     parameters%RTMR25    =    NoahmpIO%RTMR25_TABLE(CROPTYPE) ! root
                          ! maintenance respiration at 25C [umol CO2/kg bio/s]
     parameters%GRAINMR25 = NoahmpIO%GRAINMR25_TABLE(CROPTYPE) ! grain
                           ! maintenance respiration at 25C [umol CO2/kg bio/s]
     parameters%LFPT      =      NoahmpIO%LFPT_TABLE(CROPTYPE,:) ! fraction of
                                                    ! carbohydrate flux to leaf
     parameters%STPT      =      NoahmpIO%STPT_TABLE(CROPTYPE,:) ! fraction of
                                                    ! carbohydrate flux to stem
     parameters%RTPT      =      NoahmpIO%RTPT_TABLE(CROPTYPE,:) ! fraction of
                                                    ! carbohydrate flux to root
     parameters%GRAINPT   =   NoahmpIO%GRAINPT_TABLE(CROPTYPE,:) ! fraction of
                                                   ! carbohydrate flux to grain
     parameters%LFCT      =      NoahmpIO%LFCT_TABLE(CROPTYPE,:) ! fraction of
                                ! carbohydrate translocation from leaf to grain
     parameters%STCT      =      NoahmpIO%STCT_TABLE(CROPTYPE,:) ! fraction of
                                ! carbohydrate translocation from stem to grain
     parameters%RTCT      =      NoahmpIO%RTCT_TABLE(CROPTYPE,:) ! fraction of
                                ! carbohydrate translocation from root to grain
     parameters%BIO2LAI   =   NoahmpIO%BIO2LAI_TABLE(CROPTYPE)   ! leaf are
                                             ! per living leaf biomass [m^2/kg]
  END IF
...
! ----------------------------------------------------------------------
  ...
  parameters%KDT    = parameters%REFKDT * parameters%DKSAT(1) / &
       parameters%REFDK
  ...
  IF(SOILTYPE(1) /= 14) then
     FRZFACT = (parameters%SMCMAX(1) / parameters%SMCREF(1)) * &
          (0.412 / 0.468)
