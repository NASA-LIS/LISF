...
!BOP
! !ROUTINE: noahmp50_updatesnowvars
! \label{noahmp50_updatesnowvars}
!
! !REVISION HISTORY:
!    May 2023: Cenlin He; modified for refactored NoahMP v5 and later
! !INTERFACE:
subroutine noahmp50_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use noahmp50_lsmMod
...
end subroutine noahmp50_updatesnowvars
