...
!BOP
! !ROUTINE: noahmp50_updateusafsivars
! \label{noahmp50_updateusafsivars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp50_updateusafsivars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use NoahMP50_lsmMod
...
end subroutine noahmp50_updateusafsivars
