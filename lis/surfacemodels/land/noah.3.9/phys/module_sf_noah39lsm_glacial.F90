MODULE module_sf_noah39lsm_glacial
  USE module_model_constants_39
  USE module_sf_noah39lsm, ONLY : RD, SIGMA, CPH2O, CPICE, LSUBF, EMISSI_S, ROSR12
  !USE module_sf_noah39lsm, ONLY : LVCOEF_DATA
...
! ----------------------------------------------------------------------
       ...
       &                   SNOTIME1,                                    &
       &                   RIBB,                                        &
       &                   LVCOEF, TSOIL ) ! modified by S. Wang and Z. Wang 
! ----------------------------------------------------------------------
...
! ----------------------------------------------------------------------
    ...
    REAL, INTENT(IN)    :: EMBRD   ! SW, this variable is a input instead of an output, a bug of Noah 3.9
...
END MODULE module_sf_noah39lsm_glacial
