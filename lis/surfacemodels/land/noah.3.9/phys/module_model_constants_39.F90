...
!
 ...
 MODULE module_model_constants_39
...
! for calls to set_tiles
 ...
 CONTAINS
   SUBROUTINE init_module_model_constants_39
   END SUBROUTINE init_module_model_constants_39
 END MODULE module_model_constants_39
