...
!BOP
! !ROUTINE: noah39_getrunoffs_rapid
!  \label{noah39_getrunoffs_rapid}
!
! !REVISION HISTORY:
! 25 May 2021: Yeosang Yoon; Initial Specification
!
! !INTERFACE:
subroutine noah39_getrunoffs_rapid(n)
! !USES:
  use ESMF
...
end subroutine noah39_getrunoffs_rapid
