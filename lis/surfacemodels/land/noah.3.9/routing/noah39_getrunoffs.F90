...
!BOP
! !ROUTINE: noah39_getrunoffs
!  \label{noah39_getrunoffs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noah39_getrunoffs(n)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)  !units?
     runoff1(t) = noah39_struc(n)%noah(t)%runoff1
     runoff2(t) = noah39_struc(n)%noah(t)%runoff2 
  enddo
...
end subroutine noah39_getrunoffs
