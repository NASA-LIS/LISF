...
! ==================================================================================================
  ...
  SUBROUTINE NOAHMP_GLACIER (&
                   ILOC    ,JLOC    ,&
                   alb_opt, snf_opt, tbot_opt, stc_opt, glac_opt, &
                   COSZ    ,NSNOW   ,NSOIL   ,DT      , & ! IN : Time/Space/Model-related
...
! input
  ...
  integer                        , intent(in)    :: alb_opt, snf_opt, tbot_opt, stc_opt, glac_opt
...
!Added by SVK to avoid initialization errors
        MOZ = 0.0
