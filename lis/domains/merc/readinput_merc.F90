...
!  real, allocatable :: param_dd(:,:)
  ...
  allocate(run_dd(LIS_rc%nnest,7))
...
!  call LIS_readDomainConfigSpecs("param domain",param_dd)
  ...
  do n=1,LIS_rc%nnest
     ...
     write(LIS_logunit,*)'DOMAIN details: Running in merc projection'
...
!parameter data 
     call map_set(PROJ_MERC, LIS_rc%gridDesc(n,34),LIS_rc%gridDesc(n,35),&
          LIS_rc%gridDesc(n,8)*1000.0,LIS_rc%gridDesc(n,11),&
          LIS_rc%gridDesc(n,10),&
