...
!BOP
!
! !ROUTINE: downscaled_merra2_cloud_4km
!
! !REVISION HISTORY:
...
! downscaled_merra2_cloud_4km.f90 -o downscaled_merra2_cloud_4km
...
!
! !DESCRIPTION:
! This program downscales daily MERRA-2/LIS precipitation fields using
! monthly MODIS Terra and Aqua cloud-frequency information. The output is a
! daily 4-km NetCDF precipitation file on the NLDAS-3 grid.
!
!EOP
