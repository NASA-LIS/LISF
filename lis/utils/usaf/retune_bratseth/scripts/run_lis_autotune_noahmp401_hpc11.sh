...
#------------------------------------------------------------------------------
#
# SCRIPT: run_lis_autotune_noahmp401_hpc11.sh
#
...
# supercomputer running SLURM batch queueing system.  NOTE: Paths must be
# customized before running script.
#
# USAGE:  sbatch run_lis_autotune_noahmp401_hpc11.sh $YYYYMMDDHH $DD
...
SCRIPTDIR=/lustre/storm/nwp601/proj-shared/emkemp/LISFV7.6/lis/noahmp401_autotune/scripts
CFGDIR=/lustre/storm/nwp601/proj-shared/emkemp/LISFV7.6/lis/noahmp401_autotune/cfgs
BINDIR=/lustre/storm/nwp601/proj-shared/emkemp/LISFV7.6/lis/noahmp401_autotune/bin
...
# The end
echo "INFO, Completed NoahMP401 autotuning at `date`"
touch noahmp401.autotune.job.done
exit 0
