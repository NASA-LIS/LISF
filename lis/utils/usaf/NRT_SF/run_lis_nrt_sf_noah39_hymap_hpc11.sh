...
#------------------------------------------------------------------------------
#
# SCRIPT: run_lis_nrt_sf_noah39_hymap_hpc11.sh
#
# Batch script for running Noah39 and HYMAP-based (and MERIT-based)
...
lisconfig=lis.config.foc.nrt_streamflow.noah39.hymap.76
