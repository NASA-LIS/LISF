...
LDT diagnostic file:                    ldtlog.s2s_global.smap_cdf
Mask-parameter fill diagnostic file:    MaskParamFill.s2s_global.smap_cdf.log
...
Name of the preprocessed DA file:          ./smap_c007_cdf_100obs

Apply anomaly correction to obs:            0
Temporal resolution of CDFs:               "monthly"
Number of bins to use in the CDF:           100
Observation count threshold:                40
Temporal averaging interval:                1da
Apply external mask:                        0
External mask directory:                    none

# NASA SMAP soil moisture data designation:       SPL2SMP
# NASA SMAP soil moisture observation directory:   ./RS_DATA/SMAP/SPL2SMP_Aug2020
NASA SMAP soil moisture data designation:        SPL3SMP
NASA SMAP soil moisture observation directory:   ./RS_DATA/SMAP/SPL3SMP.007
NASA SMAP search radius for openwater proximity detection:  3
SMAP(NASA) soil moisture Composite Release ID (e.g., R16):  R17   # T16 
