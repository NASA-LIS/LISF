...
def get_rename_dictionary_hydroscs_to_hydrosfs():
    ...
    return {get_hydroscs_name(key_variable):get_hydrosfs_name(key_variable) for key_variable in dictionary.keys()}

def get_rename_dictionary_cfsv2_to_hydrosfs():
    """ Helper function to return renaming dictionary from GEOSv3 to HydroSFS """
    return {get_cfsv2_name(key_variable):get_hydrosfs_name(key_variable) for key_variable in dictionary.keys()}

def get_rename_dictionary_geosv3_to_hydrosfs():
    """ Helper function to return renaming dictionary from GEOSv3 to HydroSFS """
    return {get_geosv3_name(key_variable):get_hydrosfs_name(key_variable) for key_variable in dictionary.keys()}