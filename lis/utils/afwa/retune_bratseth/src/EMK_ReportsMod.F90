...
contains
   ...
   !---------------------------------------------------------------------------
   subroutine appendToReports(this,network,platform,yyyymmddhh,latitude, &
        longitude,O,B,A)
   ...
   subroutine bcast_reports(this,myid,ierr)
      ...
      call mpi_bcast(this%networks,nobs,MPI_CHARACTER,0,MPI_COMM_WORLD,ierr)
      if (ierr .ne. MPI_SUCCESS) return
      call mpi_bcast(this%platforms,nobs,MPI_CHARACTER,0,MPI_COMM_WORLD,ierr)
      if (ierr .ne. MPI_SUCCESS) return
      call mpi_bcast(this%yyyymmddhh,nobs,MPI_CHARACTER,0,MPI_COMM_WORLD,ierr)
      if (ierr .ne. MPI_SUCCESS) return
