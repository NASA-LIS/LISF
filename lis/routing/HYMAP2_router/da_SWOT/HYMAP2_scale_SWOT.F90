...
!BOP
! !ROUTINE: HYMAP2_scale_SWOT
! \label{HYMAP2_scale_SWOT}
!
! !REVISION HISTORY:
! 15 Apr 24: Yeosang Yoon; Initial specification;
!                          copied from HYMAP2_scale_WL
!
! !INTERFACE:
subroutine HYMAP2_scale_SWOT(n, Routing_State)
...
end subroutine HYMAP2_scale_SWOT
