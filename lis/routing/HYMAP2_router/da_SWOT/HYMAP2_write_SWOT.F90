...
!BOP
! !ROUTINE: HYMAP2_write_SWOT
! \label{HYMAP2_write_SWOT}
!
! !REVISION HISTORY:
! 15 Apr 24: Yeosang Yoon; Initial specification;
!                          copied from HYMAP2_write_WL
!
! !INTERFACE:
subroutine HYMAP2_write_SWOT(ftn,n, Routing_State)
...
end subroutine HYMAP2_write_SWOT
