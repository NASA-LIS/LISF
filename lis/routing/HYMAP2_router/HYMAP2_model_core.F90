...
! ================================================
 ...
 enddo
  ...
  allocate(next_glb(HYMAP2_routing_struc(n)%nseqall_glb))
  allocate(rivout_glb(HYMAP2_routing_struc(n)%nseqall_glb))
  allocate(fldout_glb(HYMAP2_routing_struc(n)%nseqall_glb))
  allocate(uprivout_glb(HYMAP2_routing_struc(n)%nseqall_glb))
  allocate(upfldout_glb(HYMAP2_routing_struc(n)%nseqall_glb))
...
!EOP
  ...
  integer, intent(in)     :: n 
  real,    intent(in)     :: var(HYMAP2_routing_struc(n)%nseqall)
  real,    intent(out)    :: var_glb(HYMAP2_routing_struc(n)%nseqall_glb)
