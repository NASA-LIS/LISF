...
contains
  ! ================================================               
  subroutine HYMAP3_calc_urban_drain_stonxt(zdt,zdrvel,zdrtotwth,zdrstomax,zdrout,zdrinf,rivdph,zdrsto,zrivsto)
    implicit none
    real, intent(in) :: zdt
  ...
  ! ================================================               
  subroutine  HYMAP3_calc_urb_drain_out(zdt,zdrrad,zdrman,zdrslp,zdrstomax,zdrtotlgh,zdrnoutlet,zdrsto,zdrout)
    implicit none
    real, intent(in) :: zdt
    ...
    !============================================= 
  subroutine HYMAP3_get_urban_parameters(drfile,drwth,drhgt,drden,drvel,drblk,drrad,drlgh,drman,drslp) 
    ...
    ! ================================================              
  subroutine HYMAP3_gen_urban_drain_maps(nseqall,drrad,drlgh,drden,drwth,drblk,&
 ...
 end subroutine HYMAP3_gen_urban_drain_maps
  ! ================================================              
end module HYMAP3_urbanMod
