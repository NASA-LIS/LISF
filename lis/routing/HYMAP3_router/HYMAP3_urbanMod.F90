...
module HYMAP3_urbanMod
  ...
  public :: HYMAP3_calc_urb_drain_out
  public :: HYMAP3_get_urban_parameters
  public :: HYMAP3_gen_urban_drain_maps
...
contains
  ...
  subroutine HYMAP3_get_urban_parameters(drfile, drwth, drhgt, drden, &
    ...
    real, intent(out) :: drwth,drhgt,drden,drvel,drblk,drrad,drlgh, &
         drman,drslp
    ...
    if(file_exists)then
       ...
       write(LIS_logunit,*) &
            '[ERR] urban drainage paramater file '//trim(drfile)
