...
!               GWBMIPrunoffdata_struc(n)%n11)
          ...
          allocate(GWBMIPrunoffdata_struc(n)%n11(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
          allocate(GWBMIPrunoffdata_struc(n)%n12(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
          allocate(GWBMIPrunoffdata_struc(n)%n21(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
          allocate(GWBMIPrunoffdata_struc(n)%n22(LIS_rc%lnc(n)*LIS_rc%lnr(n)))

          allocate(GWBMIPrunoffdata_struc(n)%w11(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
          allocate(GWBMIPrunoffdata_struc(n)%w12(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
          allocate(GWBMIPrunoffdata_struc(n)%w21(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
          allocate(GWBMIPrunoffdata_struc(n)%w22(LIS_rc%lnc(n)*LIS_rc%lnr(n)))
