...
#------------------------------------------------------------------------------
#
# SCRIPT: run_ldt_noahmp401_srtm_hpc11.sh
#
# Batch script for running LDT to generate SRTM-based LIS parameter file
# for NoahMP401 LSM on HPC11. Output is used by NoahMP401-based NRT LIS runs.
#
# REVISION HISTORY:
...
ldtconfig=ldt.config.foc.nrt.noahmp401.param.76
