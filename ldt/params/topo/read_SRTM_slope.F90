...
!BOP
!
! !ROUTINE: read_SRTM_slope
! \label{read_SRTM_slope}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_SRTM_slope( n, num_bins, fgrd, slopeave )
...
! !DESCRIPTION:
!  This subroutine retrieves static slope data from the SRTM source
...
!________________________________________________________________________
  ...
  write(LDT_logunit,*) "Reading slope file: ",trim(LDT_rc%slfile(n))
...
!- Transform parameter grid to LIS run domain:
 ...
 !- Transforming 3-D slope field: 
   ...
   write(LDT_logunit, *) "[INFO] Done reading SRTM slope file."

end subroutine read_SRTM_slope
