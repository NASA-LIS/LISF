...
!BOP
!
! !ROUTINE: read_GTOPO30_aspect
! \label{read_GTOPO30_aspect}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_GTOPO30_aspect( n, num_bins, fgrd, aspectave )
...
! !DESCRIPTION:
!  This subroutine retrieves static aspect data from the GTOPO30 source
...
!________________________________________________________________________
  ...
  write(LDT_logunit,*) "[INFO] Reading GTOPO30 (LIS-based) aspect file: ",&
                       trim(LDT_rc%aspfile(n))
...
!- Transform parameter grid to LIS run domain:
 ...
 !- Transforming 3-D aspect field: 
   ...
   write(LDT_logunit, *) "[INFO] Done reading GTOPO30 aspect file."

end subroutine read_GTOPO30_aspect
