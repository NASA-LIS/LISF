...
!BOP
!
! !ROUTINE: read_SRTM_elev
! \label{read_SRTM_elev}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_SRTM_elev( n, num_bins, fgrd, elevave )
...
!________________________________________________________________________
  ...
  write(LDT_logunit,*) "Reading SRTM elevation file: ",trim(LDT_rc%elevfile(n))
...
!- Transform parameter grid to LIS run domain:
 ...
 !- Transforming 3-D elevation field: 
   ...
   write(LDT_logunit, *) "[INF0] Done reading SRTM elevation file."

end subroutine read_SRTM_elev
