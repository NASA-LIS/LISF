...
!BOP
!
! !ROUTINE: read_HYMAP_river_length
! \label{read_HYMAP_river_length}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_HYMAP_river_length(n, array)
...
!EOP      
  ...
  if(.not.file_exists) then 
     write(LDT_logunit,*) '[ERR] HYMAP river length map, ',&
...
end subroutine read_HYMAP_river_length
