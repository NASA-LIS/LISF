...
!BOP
!
! !ROUTINE: read_HYMAP_grid_dist
! \label{read_HYMAP_grid_dist}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_HYMAP_grid_dist(n, array)
! !USES:
  use ESMF
...
!EOP      
  ...
  open(ftn, file=trim(HYMAP_struc(n)%griddistfile), access='direct',&
...
end subroutine read_HYMAP_grid_dist
