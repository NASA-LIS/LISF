...
!BOP
!
! !ROUTINE: read_HYMAP_runoff_dwi_ratio
! \label{read_HYMAP_runoff_dwi_ratio}
!
! !REVISION HISTORY:
!  25 Jul 2005: Sujay Kumar; Initial Specification
!  08 Dec 2016: Sujay Kumar; Adapt to runoff deep water infiltration (DWI) ratio
!
! !INTERFACE:
subroutine read_HYMAP_runoff_dwi_ratio(n, array)
...
!EOP      
  ...
  if(.not.file_exists) then 
     write(LDT_logunit,*) '[ERR] HYMAP runoff dwi ratio map, ',&
...
end subroutine read_HYMAP_runoff_dwi_ratio
