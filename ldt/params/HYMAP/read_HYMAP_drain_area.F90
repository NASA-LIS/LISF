...
!BOP
!
! !ROUTINE: read_HYMAP_drain_area
! \label{read_HYMAP_drain_area}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_HYMAP_drain_area(n, array)
! !USES:
  use ESMF
...
!EOP      
  ...
  if(.not.file_exists) then 
     write(LDT_logunit,*) '[ERR] HYMAP drainage area map, ',&
...
end subroutine read_HYMAP_drain_area
