...
!BOP
!
! !ROUTINE: read_HYMAP_runoff_delay
! \label{read_HYMAP_runoff_delay}
!
! !REVISION HISTORY:
!  25 Jul 2005: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine read_HYMAP_runoff_delay(n, array)
...
!EOP      
  ...
  if(.not.file_exists) then 
     write(LDT_logunit,*) '[ERR] HYMAP runoff time delay map, ',&
...
end subroutine read_HYMAP_runoff_delay
