...
!BOP
!
! !ROUTINE: read_CONSTANT_slopetype_cro
! \label{read_CONSTANT_slopetype_cro}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine read_CONSTANT_slopetype_cro(n, array)
...
end subroutine read_CONSTANT_slopetype_cro
