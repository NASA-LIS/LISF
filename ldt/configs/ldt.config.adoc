...
This simulator can handle the use of external orbital masks to be applied to the observations created for OSSEs. Currently, AMSR2, TSMM, Sentinel-1A, and MODIS are available instrumental options.
...
'Observation simulator nature run source:' specifies a nature run source.
'Observation simulator OSSE mask source:' specifies an OSSE mask source.
'Observation simulator type of temporal transform:' specifies a type of temporal transform.
                                                    available options: 'instantanuous', 'time-averaged'.
'Observation simulator masking model type:' specifies a masking model type.
                                            available options: 'constant','time-varying'.
...
'Observation simulator simulated variables:' specifies the simulated variables.
...
'Observation simulator error model type:' specifies an error model type.
                                          available options: 'additive','multiplicative'.
'Observation simulator error distribution type:' specifies a type of error model.
                                          available option: 'gaussian'
'Observation simulator error standard deviation:' specifies an error standard deviation.

.Decription
Initializing the structures required for the handling of a land surface model output (from a LIS simulation) as
observations.
...
'AMSR2 OSSE mask data resolution (km):' specifies a resolution of OSSE mask.
