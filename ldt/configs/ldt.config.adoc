...
|CHELSAV21 |Global climate layers downscaled. For more info, see: http://chelsa-climate.org/
|NAFPA_BACK_GFS | Global GFS precipitation downscaled, used as background for NAFPA
|NAFPA_BACK_GALWEM | Global GALWEM precipitation downscaled, used as background for NAFPA
|NAFPA_IMERG | Global IMERG monthly precipitation remapped to NAFPA grid
...
CHELSAV21: <directory>/<file header>_<imonth>_<iyear>_V.2.1.tif

* The file header is CHELSA_pr
* The imonth represents the month (01, 02, ..., 12)
* The iyear represents the year (1979, 1980, ..., 2019).

NAFPA_BACK_GFS: <directory>/SUM_TS.<iyear><imonth>010000.d01.nc
* The iyear represents the year (2008, 2009, ..., 2017).
* The imonth represents the month (01, 02, ..., 12)
* NOTE: The iyear/imonth refers to the end of the previous month.

NAFPA_BACK_GALWEM: <directory>/SUM_TS.<iyear><imonth>010000.d01.nc
* The iyear represents the year (2017, 2018, ..., 2021).
* The imonth represents the month (01, 02, ..., 12)
* NOTE: The iyear/imonth refers to the end of the previous month.

NAFPA_IMERG: <directory>/SUM_TS.<iyear><imonth>010000.d01.nc
* The iyear represents the year (2017, 2018, ..., 2021).
* The imonth represents the month (01, 02, ..., 12)
* NOTE: The iyear/imonth refers to the end of the previous month.
