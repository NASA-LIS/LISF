...
! 08 Jul 2025  Eric Kemp  Ported to SNIP.
!
! DESCRIPTION:
...
module SNIP_bratsethMod
  ...
  type, public :: SNIP_bratseth_t
   ...
   contains
     ! Object methods
     procedure :: new => SNIP_bratseth_new
     procedure :: delete => SNIP_bratseth_delete
     procedure :: count_good_obs => SNIP_bratseth_count_good_obs
     procedure :: append_ob => SNIP_bratseth_append_ob
     procedure :: calc_inv_data_dens => SNIP_bratseth_calc_inv_data_dens
     procedure :: calc_ob_anas => SNIP_bratseth_calc_ob_anas
     procedure :: calc_grid_anas => SNIP_bratseth_calc_grid_anas
     procedure :: run_dup_qc => SNIP_bratseth_run_dup_qc
     procedure :: run_water_qc => SNIP_bratseth_run_water_qc
     procedure :: run_superstat_qc => SNIP_bratseth_run_superstat_qc
     procedure :: run_back_qc => SNIP_bratseth_run_back_qc
     procedure :: run_skewed_back_qc => SNIP_bratseth_run_skewed_back_qc
     procedure :: run_elev_qc => SNIP_bratseth_run_elev_qc
     procedure :: get_lat_lon => SNIP_bratseth_get_lat_lon
     procedure :: set_back => SNIP_bratseth_set_back
     procedure :: reject_ob => SNIP_bratseth_reject_ob
     procedure :: resort_bad_obs => SNIP_bratseth_resort_bad_obs
     procedure :: get_ob_value => SNIP_bratseth_get_ob_value
     procedure :: run_nosnow_qc => SNIP_bratseth_run_nosnow_qc
     procedure :: run_missing_elev_qc => SNIP_bratseth_run_missing_elev_qc
     procedure :: sort_obs_by_id => SNIP_bratseth_sort_obs_by_id
     procedure :: print_snowdepths => SNIP_bratseth_print_snowdepths
     procedure :: count_all_obs => SNIP_bratseth_count_all_obs
     procedure :: mark_good_obs => SNIP_bratseth_mark_good_obs
  end type SNIP_bratseth_t
...
contains
  ...
  ! Constructor for SNIP_bratseth_t object
  subroutine SNIP_bratseth_new(this, maxobs, back_err_var, &
    ...
    this%anas(:) = MISSING
    this%npasses = 0
  end subroutine SNIP_bratseth_new

  ! Destructor for SNIP_bratseth_t object
  subroutine SNIP_bratseth_delete(this)
  ...
  end subroutine SNIP_bratseth_delete

  ! Get count of all obs in SNIP_bratseth_t object with "good" quality
  ! control flags
  function SNIP_bratseth_count_good_obs(this) result (count)
    implicit none
    class(SNIP_bratseth_t), intent(in) :: this
    integer :: count
    integer :: i
    count = 0
    do i = 1, this%nobs
  ...
  end function SNIP_bratseth_count_good_obs

  ! Append a single observation into a SNIP_bratseth_t object.  Value of
  ! interpolated background value is optional (useful for adding
  ! "superobservations")
  subroutine SNIP_bratseth_append_ob(this, network, platform, ob, &
  ...
  end subroutine SNIP_bratseth_append_ob

  ! Checks if observation network is recognized as surface snow report.
  logical function SNIP_bratseth_is_snow_stn(net)
    implicit none
    ...
    SNIP_bratseth_is_snow_stn = answer
  end function SNIP_bratseth_is_snow_stn
  ...
  subroutine SNIP_bratseth_calc_inv_data_dens(this, silent)
  ...
  end subroutine SNIP_bratseth_calc_inv_data_dens
  ...
  end subroutine SNIP_bratseth_calc_ob_anas
  ...
  subroutine SNIP_bratseth_calc_grid_anas(this, n, ncols, nrows, &
       gbacks, gelevs, ganas, skip_grid_points)
  ...
  end subroutine SNIP_bratseth_calc_grid_anas
  ...
  end subroutine SNIP_bratseth_run_dup_qc

  ! Reject observations over water
  subroutine SNIP_bratseth_run_water_qc(this, n, ncols, nrows, &
       landmask, silent_rejects)
  ...
  end subroutine SNIP_bratseth_run_elev_qc

  ! Get lat/lon of observation
  subroutine SNIP_bratseth_get_lat_lon(this, job, lat, lon)
    implicit none
    class(SNIP_bratseth_t), intent(in) :: this
    ...
    lat = this%lats(job)
    lon = this%lons(job)
  end subroutine SNIP_bratseth_get_lat_lon

  ! Set the interpolated background value for a specific ob
  subroutine SNIP_bratseth_set_back(this, job, back)
    implicit none
    class(SNIP_bratseth_t), intent(inout) :: this
    integer, intent(in) :: job
    real, intent(in) :: back
    this%backs(job) = back
  end subroutine SNIP_bratseth_set_back

  ! Reject specified observation.  Useful if background is missing or
  ! snomask disagrees.
  subroutine SNIP_bratseth_reject_ob(this, job, reason)
    implicit none
    class(SNIP_bratseth_t), intent(inout) :: this
    integer, intent(in) :: job
  ...
  end subroutine SNIP_bratseth_reject_ob
  ...
  end subroutine SNIP_bratseth_resort_bad_obs

  ! Return observed value
  subroutine SNIP_bratseth_get_ob_value(this, job, ob_value)
    implicit none
    class(SNIP_bratseth_t), intent(in) :: this
    integer, intent(in) :: job
    real, intent(out) :: ob_value
    ob_value = this%obs(job)
  end subroutine SNIP_bratseth_get_ob_value

  ! Reject obs where snow is not permitted
  subroutine SNIP_bratseth_run_nosnow_qc(this, nc, nr, snow_poss)
  ...
  end subroutine SNIP_bratseth_run_nosnow_qc

  ! Reject obs that are missing elevations
  subroutine SNIP_bratseth_run_missing_elev_qc(this)
  ...
  end subroutine SNIP_bratseth_sort_obs_by_id

  ! Print out any station with a snow depth
  subroutine SNIP_bratseth_print_snowdepths(this, minprt)
    use LDT_logMod, only: LDT_logunit
    implicit none
    class(SNIP_bratseth_t), intent(in) :: this
...
7000 format (/,'[INFO] NETID = ',A5,' STATION ID = ',A32, &
         ...
         '   QC VERDICT = ',A)
  end subroutine SNIP_bratseth_print_snowdepths

  ! Retrieve total obs
  function SNIP_bratseth_count_all_obs(this) result (count)
    implicit none
    class(SNIP_bratseth_t), intent(in) :: this
    integer :: count
    count = this%nobs
  end function SNIP_bratseth_count_all_obs

  ! Mark good obs
  subroutine SNIP_bratseth_mark_good_obs(this)
    implicit none
    class(SNIP_bratseth_t), intent(inout) :: this
  ...
  end subroutine SNIP_bratseth_mark_good_obs
end module SNIP_bratsethMod
