...
contains
  ...
  subroutine abort_message (program_name, routine_name, message)
    ...
    !**  UPDATES
    !**  =======
    !**  11 MAY 11 INITIAL VERSION (FROM ERROR_MESSAGE)...................
...
8000 format (/, 1X, 75('*'),                                         &
  ...
  subroutine date10_julhr(date10, julhr, program_name, routine_name)
    ...
    !     24 Feb 2010  Converted to FTN 90 for SNODEP.....................
    !                  ...............................Mr Lewiston/16WS/WXE
    ...
    !     09 Jul 2025  Renamed SNIP...Eric Kemp, NASA GSFC/SSAI
    !
    !---------------------------------------------------------------------
    !---------------------------------------------------------------------
...
9000 continue
  ...
  subroutine error_message (program_name, routine_name, yyyymmddhh, &
    ...
    !**  UPDATES
    !**  =======
    !**  22 FEB 01 INITIAL VERSION (REUSED FROM ADVCLD)...................
    !**            .......................................SSGT MILLER/DNXM
    !**  21 JUL 04 CONVERTED TO FORTRAN 90 FOR 16TH MESH..................
    !**            .......................................MR EYLANDER/DNXM
    ...
    !**    of USAFSI analysis...Eric Kemp, NASA GSFC/SSAI
    !**  09 Jul 25  Ported to SNIP...Eric Kemp, NASA GSFC/SSAI
    !**
    !*********************************************************************
    !*********************************************************************
...
8000 format (/, 1X, 75('*'),                                          &
  ...
  subroutine julhr_date10( julhr, date10, program_name, routine_call )
    ...
    !     09 May 2019  Renamed LDTSI...Eric Kemp, NASA GSFC/SSAI
    !     13 Dec 2019  Renamed USAFSI...Eric Kemp, NASA GSFC/SSAI
    !     09 Jul 2025  Ported to SNIP...Eric Kemp, NASA GSFC/SSAI
    !
    !---------------------------------------------------------------------
    !---------------------------------------------------------------------
...
9300 continue
  ...
  subroutine putget_int1 ( buffer, iofunc, file_name, program_name, &
    ...
    !**
    !**  PURPOSE:  Read 1-byte integer data from or write to direct
    !**    access files.
    !**
    !**  METHOD
    !**  ======
    ...
    !**  INTERFACE
    !**  =========
    !**   INPUT:  BUFFER, IOFUNC, FILE_NAME, PROGRAM_NAME, ROUTINE_NAME,
    !**           IGRID, JGRID
    !**
    !**   OUTPUT: BUFFER
    !**
    ...
    !**  UPDATES
    !**  =======
    !**  24 Feb 10 Initial version (adapted from putget_int)..............
    !**            ...................................Mr Lewiston/16WS/WXE
    !**  22 Mar 19 Ported to LDT...Eric Kemp, NASA GSFC/SSAI
    !**
    !*********************************************************************
...
4000 continue
  ...
  subroutine putget_int ( buffer, iofunc, file_name, program_name,  &
    ...
    !**  24 Feb 10 Converted to FORTRAN 90 for SNODEP.....................
    !**            ...................................Mr Lewiston/16WS/WXE
    !**  22 Mar 19 Ported to LDT...Eric Kemp, NASA GSFC/SSAI
    !**  09 May 19 Renamed LDTSI...Eric Kemp, NASA GSFC/SSAI
    !**  13 Dec 19 Renamed USAFSI...Eric Kemp, NASA GSFC/SSAI
...
4000 continue
  ...
  subroutine tmjul4( hour, day, month, year, julhr )
    ...
    !               assignment statement.  Ported to IBM SP2.............
    !               ........................................Mr Gayno/DNXM
