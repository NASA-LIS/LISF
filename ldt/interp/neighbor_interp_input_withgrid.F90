...
!BOP
! !ROUTINE: neighbor_interp_input_withgrid
! \label{neighbor_interp_input_withgrid}
!
! !INTERFACE:    
subroutine neighbor_interp_input_withgrid (gridDesci,gridDesco, npts, rlat2,rlon2,n112)
...
end subroutine neighbor_interp_input_withgrid
