...
! longitude lon_a and longitude lon_b, you would subtract
! them --- dlon = lon_a - lon_b
!
...
!
!    dlon = diff_lon(lon_a, lon_b)
!
! I.e.; the order of the arguments to diff_lon are in the same
