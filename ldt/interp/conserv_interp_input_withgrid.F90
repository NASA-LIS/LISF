...
!BOP
! 
! !ROUTINE: conserv_interp_input_withgrid
! \label{conserv_interp_input_withgrid}
! 
! !INTERFACE:
  subroutine conserv_interp_input_withgrid(gridDesci,gridDesco,npts,&
...
!             print*, 'def ',n,nb,n113(n,nb),n213(n,nb)
    ...
    enddo
  end subroutine conserv_interp_input_withgrid
