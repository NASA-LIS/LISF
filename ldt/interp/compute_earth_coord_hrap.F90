...
!BOP
! 
! !ROUTINE: compute_earth_coord_hrap
!  \label{compute_earth_coord_hrap}
!
! !REVISION HISTORY: 
...
!
! !INTERFACE:
subroutine compute_earth_coord_hrap(gridDesc,npts,fill,xpts,ypts,& 
                         rlon,rlat,nret)
! !USES:   
  use map_utils
...
!  This routine is based on the decoding routines
!  in the NCEP interoplation package and has been
!  modified from the adopted module from the Weather
...
end subroutine compute_earth_coord_hrap
