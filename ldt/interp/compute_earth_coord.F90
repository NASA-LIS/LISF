...
!    \item[gen\_xypts]
!     logical that specifies whether this routine should generate
!     xpts and ypts.  Example: This routine is called twice when computing
!     weights and neighbours for the conservative intepolation scheme.  The
!     first call must generate xpts and ypts.  The second call should not.
!    \end{description}
!
...
! UTM
  elseif(gridDesc(1).eq.7) then
     call compute_earth_coord_UTM(gridDesc,npts,fill,xpts,ypts,&
          rlon,rlat,nret)
!  HRAP
