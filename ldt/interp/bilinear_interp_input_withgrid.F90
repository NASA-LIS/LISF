...
!BOP
! !ROUTINE: bilinear_interp_input_withgrid
! \label{bilinear_interp_input_withgrid}
!
! !INTERFACE:    
subroutine bilinear_interp_input_withgrid (gridDesci,gridDesco, npts,&
     rlat,rlon,n11,n12,n21,n22,w11,w12,w21,w22)

  implicit none
! !ARGUMENTS:
  real, intent(in)    :: gridDesci(20)
  real, intent(in)    :: gridDesco(20)
  integer             :: npts
  real                :: rlat(npts)
  real                :: rlon(npts)
...
!EOP
  ...
  enddo
end subroutine bilinear_interp_input_withgrid
