...
//BOP
// !ROUTINE: xmrg\_read\_data\_c\_
// \label{xmrg_read_data_c_}
int xmrg_read_data_c_(char *in_file_name, float *data1d, float *nodata_default)
// !DESCRIPTION:
...
// Functions invoked by xmrg_read_header_c are
// \begin{description}
