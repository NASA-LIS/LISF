...
/* Function prototypes */
int FTN(ldt_create_subdirs) (int *length, char *path);

/*****************************************************************************/
/*                                                                           */
/* ROUTINE: LDT_create_subdirs                                               */
/*                                                                           */
...
int FTN(ldt_create_subdirs) (int  *length,
			     char *path) {
  ...
  if (*length == 0) {
	puts("ERROR, zero length string sent to LDT_create_subdirs!");
	status = 1;
	return status;
  }
