...
!      endif
 ...
 end subroutine LDT_soils_init


 subroutine LDT_soils_writeHeader(n,ftn,dimID)
...
#endif
  end subroutine LDT_soils_writeHeader

  subroutine LDT_soils_writeData(n,ftn)
...
!    endif
  ...
  end subroutine LDT_soils_writeData
