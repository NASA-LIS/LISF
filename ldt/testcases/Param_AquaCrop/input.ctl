...
options template
undef -9999
xdef 28 linear -102.875 0.25
ydef 22 linear 34.375 0.25
zdef 1 linear 1 1
* dummy tdef
...
AC_CROPT=>AC_CROPT 1 y,x description
AC_comp_size=>AC_comp_size1 0 0,y,x description
AC_comp_size=>AC_comp_size2 0 1,y,x description
AC_comp_size=>AC_comp_size3 0 2,y,x description
AC_comp_size=>AC_comp_size4 0 3,y,x description
AC_comp_size=>AC_comp_size5 0 4,y,x description
AC_comp_size=>AC_comp_size6 0 5,y,x description
AC_comp_size=>AC_comp_size7 0 6,y,x description
AC_comp_size=>AC_comp_size8 0 7,y,x description
AC_comp_size=>AC_comp_size9 0 8,y,x description
AC_comp_size=>AC_comp_size10 0 9,y,x description
AC_comp_size=>AC_comp_size11 0 10,y,x description
AC_comp_size=>AC_comp_size12 0 11,y,x description
AC_Tmin_clim=>AC_Tmin_clim1 0 0,y,x description
AC_Tmin_clim=>AC_Tmin_clim2 0 1,y,x description
AC_Tmin_clim=>AC_Tmin_clim3 0 2,y,x description
AC_Tmin_clim=>AC_Tmin_clim4 0 3,y,x description
AC_Tmin_clim=>AC_Tmin_clim5 0 4,y,x description
AC_Tmin_clim=>AC_Tmin_clim6 0 5,y,x description
AC_Tmin_clim=>AC_Tmin_clim7 0 6,y,x description
AC_Tmin_clim=>AC_Tmin_clim8 0 7,y,x description
AC_Tmin_clim=>AC_Tmin_clim9 0 8,y,x description
AC_Tmin_clim=>AC_Tmin_clim10 0 9,y,x description
AC_Tmin_clim=>AC_Tmin_clim11 0 10,y,x description
AC_Tmin_clim=>AC_Tmin_clim12 0 11,y,x description
AC_Tmax_clim=>AC_Tmax_clim1 0 0,y,x description
AC_Tmax_clim=>AC_Tmax_clim2 0 1,y,x description
AC_Tmax_clim=>AC_Tmax_clim3 0 2,y,x description
AC_Tmax_clim=>AC_Tmax_clim4 0 3,y,x description
AC_Tmax_clim=>AC_Tmax_clim5 0 4,y,x description
AC_Tmax_clim=>AC_Tmax_clim6 0 5,y,x description
AC_Tmax_clim=>AC_Tmax_clim7 0 6,y,x description
AC_Tmax_clim=>AC_Tmax_clim8 0 7,y,x description
AC_Tmax_clim=>AC_Tmax_clim9 0 8,y,x description
AC_Tmax_clim=>AC_Tmax_clim10 0 9,y,x description
AC_Tmax_clim=>AC_Tmax_clim11 0 10,y,x description
AC_Tmax_clim=>AC_Tmax_clim12 0 11,y,x description
